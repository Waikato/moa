/*
 *    HoeffdingOptionTreeNBAdaptive.java
...
/**
 * Hoeffding Option Tree with majority class and naive Bayes learners at the
 * leaves.
 *
 * <p>Decision option tree for streaming data with adaptive Naive Bayes
 * classiﬁcation at leaves. This adaptive Naive Bayes prediction method monitors
 ...
 * more accurate in past cases.</p>
 *
 * <p>Parameters:</p> <ul>
 * <li>Same parameters as HoeffdingOptionTreeNB</li> </ul>
 *
 * @author Richard Kirkby (rkirkby@cs.waikato.ac.nz)
 * @version $Revision: 7 $
 */
public class HoeffdingOptionTreeNBAdaptive extends HoeffdingOptionTreeNB {

    private static final long serialVersionUID = 1L;

    @Override
    public String getPurposeString() {
        return " Hoeffding Option Tree with majority class and naive Bayes learners at the leaves.";
    }
