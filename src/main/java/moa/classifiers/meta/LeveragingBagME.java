 ...
 * @version $Revision: 7 $
 */
public class LeveragingBagME extends AbstractClassifier {

    private static final long serialVersionUID = 1L;

    @Override
    public String getPurposeString() {
        return " Leveraging Bagging ME for evolving data streams using ADWIN using weight 1 if misclassified, otherwise error/(1-error)";
    }    
    ...
    public FloatOption weightShrinkOption = new FloatOption("weightShrink", 'w',
            "The number to use to compute the weight of new instances.", 0.5, 0.0, Float.MAX_VALUE);
