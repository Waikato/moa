 ...
 * @version $Revision: 7 $
 */
public class LeveragingBagWT extends AbstractClassifier {

    private static final long serialVersionUID = 1L;

    @Override
    public String getPurposeString() {
        return "Leveraging Bagging WT for evolving data streams using ADWIN without taking out all instances.";
    }    
