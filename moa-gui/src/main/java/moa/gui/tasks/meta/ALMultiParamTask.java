...
import moa.gui.tasks.meta.options.ClassOptionWithListenerOption;
import moa.gui.tasks.meta.options.DependentOptionsUpdater;
...
public class ALMultiParamTask extends ALMainTask {
	...
	public ClassOptionWithListenerOption prequentialEvaluationTaskOption =
			new ClassOptionWithListenerOption(
				...
				"moa.gui.tasks.meta.ALPrequentialEvaluationTask");
