...
public class SimpleClusterTest extends TestCase {
    ...
    static final String[] Clusterers =
            new String[] {
                "ClusterGenerator",
                "CobWeb",
                "KMeans",
    ...
    public void doTask(String[] args) throws Exception {
        if (args.length < 1) {
            ...
            Option[] extraOptions =
                    new Option[] {
                        suppressStatusOutputOption,
                        suppressResultOutputOption,
            ...
            if (suppressStatusOutputOption.isSet()) {
                ...
                if (!(result instanceof FailedTaskReport)) {
                    System.out.print(
                            "Task completed in "
                                    + StringUtils.secondsToDHMSString(
                                            taskThread.getCPUSecondsElapsed()));
                    if (preciseTiming) {
