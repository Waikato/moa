...
public class HeterogeneousEnsembleBlastTest extends AbstractMultipleClassifierTestCase {
    /**
    ...
    protected Classifier[] getRegressionClassifierSetups() {
        return new Classifier[] {
            new HeterogeneousEnsembleBlast(), new HeterogeneousEnsembleBlastFadingFactors(),
        };
    }
    ...
    public void testSetup() { // TODO: test case doesn't run
        ...
        String[] ensembleComposition = {
            "trees.HoeffdingTree", "bayes.NaiveBayes", "functions.Perceptron"
        };
