 ...
 * @version $Revision$
 */
public abstract class AbstractMultipleClassifierTestCase extends AbstractClassifierTestCase {
    ...
    protected LearningPerformanceEvaluator<Example<Instance>>[] getRegressionEvaluatorSetups() {
        ...
        LearningPerformanceEvaluator<Example<Instance>>[] ret =
                new BasicClassificationPerformanceEvaluator[this.numberTests];
        for (int i = 0; i < this.numberTests; i++) {
