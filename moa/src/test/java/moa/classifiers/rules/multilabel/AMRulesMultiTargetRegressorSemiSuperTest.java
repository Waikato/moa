...
public class AMRulesMultiTargetRegressorSemiSuperTest extends AbstractMultipleRegressorTestCase {
    ...
    public static Test suite() {
        return new TestSuite(
                moa.classifiers.rules.multilabel.AMRulesMultiTargetRegressorSemiSuperTest.class);
    }
