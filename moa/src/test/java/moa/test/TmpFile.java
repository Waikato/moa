...
/** TmpFile.java Copyright (C) 2010 University of Waikato, Hamilton, New Zealand */
package moa.test;

import java.io.File;

/**
 * A simple file handler class that automatically places the file in the system's tmp directory. But
 * the user still needs to delete the file manually when it's no longer used.
 *
...
public class TmpFile extends File {
     ...
     * abstract pathname. Creates a file object pointing to the tmp directory.
     */
    public TmpFile() {
