...
/** TestHelper.java Copyright (C) 2013 University of Waikato, Hamilton, New Zealand */
package moa.test;
...
public class TestHelper<I, O> extends AbstractTestHelper<I, O> {
    ...
    /**
     * Dummy, just write the string returned by the object's toString() method to the file.
     *
    ...
    public boolean save(O data, String filename) {
        return FileUtils.writeToFile(
                new TmpFile(filename).getAbsolutePath(), data.toString(), false);
    }
}
