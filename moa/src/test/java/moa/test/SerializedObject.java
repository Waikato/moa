...
/**
 * Class for storing an object in serialized form in memory. It can be used to make deep copies of
 * objects, and also allows compression to conserve memory.
 *
...
public class SerializedObject implements Serializable {
    ...
    public SerializedObject(Serializable o, boolean compress) throws Exception {
        ...
        if (!compress) p = new ObjectOutputStream(new BufferedOutputStream(ostream));
        else p = new ObjectOutputStream(new BufferedOutputStream(new GZIPOutputStream(ostream)));
        p.writeObject(o);
        p.flush();
        p.close();
