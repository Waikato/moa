...
/** TestHelper.java Copyright (C) 2010-2013 University of Waikato, Hamilton, New Zealand */
package moa.test;
...
public abstract class AbstractTestHelper<I, O> {
        ...
        try {
            ...
            output =
                    new BufferedOutputStream(
                            new FileOutputStream(getTmpLocationFromResource(resource)));
            ...
            if (e.getMessage().equals("Stream closed")) {
                ...
                System.err.println(
                        "Resource '"
                                ...
                                + "Or extension '*."
                                + ext
                                + "' not in pom.xml ('project.build.testSourceDirectory') listed?");
            }
            e.printStackTrace();
            result = false;
        } catch (Exception e) {
    ...
    public boolean copyResourceToTmp(String resource, String newName) {
        ...
        if (result) result = renameTmpFile(resource, newName);
