 ...
 */
package moa.learners.predictors.drift;
 ...
 * @version $Revision$
 */
public class DriftDetectionMethodClassifierTest extends AbstractClassifierTestCase {
	...
	protected Classifier[] getLearnerSetups() {
		return new Classifier[] { new DriftDetectionMethodClassifier(), };
	}
