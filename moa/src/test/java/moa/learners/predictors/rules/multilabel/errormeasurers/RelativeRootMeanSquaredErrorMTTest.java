package moa.learners.predictors.rules.multilabel.errormeasurers;
...
import moa.learners.predictors.core.errormeasurers.RelativeRootMeanSquaredErrorMT;
...
public class RelativeRootMeanSquaredErrorMTTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		Prediction trueTarget = new MultiLabelClassificationPrediction(3);
		Prediction prediction = new MultiLabelClassificationPrediction(3);
		...
		trueTarget = new MultiLabelClassificationPrediction(3);
		prediction = new MultiLabelClassificationPrediction(3);
	...
	public void testGetCurrentErrors() {
		assertArrayEquals(new double[] { 0.664202694282111, 0.5147167180492306, 1.641785843993505 },
				m.getCurrentErrors(), 0.0000001);
	}
}
