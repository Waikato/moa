 ...
 * @version $Revision$
 */
public abstract class AbstractClassifierTestCase extends AbstractInstanceLearnerTestCase<Classifier> {
	...
	@Override
	public Classifier copySetup(Classifier setup) {
		return (Classifier) setup.copy();
	}
}
