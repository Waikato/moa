 ...
 * @version $Revision$
 */
public abstract class AbstractMultiTargetRegressorTestCase
		extends AbstractInstanceLearnerTestCase<MultiTargetRegressor> {
	 ...
	 */
	public AbstractMultiTargetRegressorTestCase(String name) {
		super(name);
	}
	...
	@Override
	public MultiTargetRegressor copySetup(MultiTargetRegressor setup) {
		return (MultiTargetRegressor) setup.copy();
	}
}
