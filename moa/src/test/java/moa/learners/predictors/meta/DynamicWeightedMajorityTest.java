...
import moa.learners.predictors.meta.DynamicWeightedMajority;
 ...
 * @version $Revision$
 */
public class DynamicWeightedMajorityTest extends AbstractClassifierTestCase {
	...
	protected Classifier[] getLearnerSetups() {
		return new Classifier[] { new DynamicWeightedMajority(), };
	}
