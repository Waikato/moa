...
import moa.learners.predictors.meta.HeterogeneousEnsembleBlast;
import moa.learners.predictors.meta.HeterogeneousEnsembleBlastFadingFactors;

public class HeterogeneousEnsembleBlastTest extends AbstractClassifierTestCase {
	/**
