 ...
 * @version $Revision: 7 $
 */
public class EvaluatePrequentialRegression extends AbstractEvaluatePrequential<Regressor> implements RegressionMainTask {

    private static final long serialVersionUID = 1L;
	
    public EvaluatePrequentialRegression() {
