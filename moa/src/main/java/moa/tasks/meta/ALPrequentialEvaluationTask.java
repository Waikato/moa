...
/**
 * This task performs prequential evaluation for an active learning classifier (testing, then
 * training with each example in sequence). It is mainly based on the class EvaluateALPrequentialCV.
 *
 * @author Cornelius Styp von Rekowski (cornelius.styp@ovgu.de)
 * @version $Revision: 1 $
 */
public class ALPrequentialEvaluationTask extends ALMainTask {
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        ExampleStream<Example<Instance>> stream =
                (ExampleStream<Example<Instance>>) getPreparedClassOption(this.streamOption);
        ...
        // get evaluator
        ALClassificationPerformanceEvaluator evaluator =
        ...
        while (stream.hasMoreInstances()
            ...
            if (instancesProcessed % INSTANCES_BETWEEN_MONITOR_UPDATES == 0
                ...
                monitor.setCurrentActivityFractionComplete(
                        estimatedRemainingInstances < 0 ? -1.0 : fractionComplete);
