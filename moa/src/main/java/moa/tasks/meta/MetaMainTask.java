...
/**
 * This class provides features for handling tasks in a tree-like structure of
...
public abstract class MetaMainTask extends MainTask {
	...
	/**
	 * Get the task's display name consisting of the general task name, indentation
	 * showing the tree structure depending on the subtask level and optionally a
	 * name suffix given from a supertask.
	 *
	 * @return display name
	 */
	...
	/**
	 * Set the list of booleans indicating if the current branch in the subtask tree
	 * is the last one on its respective level.
	 *
	...
	/**
	 * Get the tasks subtask level (how deep it is in the tree). 0 is the root task
	 * level.
	 *
	 * @return
	 */
	...
	/**
	 * Set the color coding for this task (the color which is used for multi-curve
	 * plots).
	 *
	...
	/**
	 * Get the color coding for this task (the color which is used for multi-curve
	 * plots).
	 *
