...
public abstract class MetaMainTask extends MainTask {
    ...
    /**
     * Get the task's display name consisting of the general task name, indentation showing the tree
     * structure depending on the subtask level and optionally a name suffix given from a supertask.
     *
     * @return display name
     */
    ...
    /**
     * Set the list of booleans indicating if the current branch in the subtask tree is the last one
     * on its respective level.
     *
