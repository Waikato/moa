 ...
 * @version $Revision: 7 $
 */
public class LearnModelMultiTargetRegression extends AbstractLearnModel<MultiTargetRegressor> implements MultiTargetRegressionMainTask {
    ...
    public LearnModelMultiTargetRegression() {
