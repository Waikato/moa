 ...
 * @version $Revision: 1 $
 */
public class EvaluatePrequentialDelayed extends MainTask implements ClassificationMainTask {
	...
	public IntOption initialWindowSizeOption = new IntOption("initialTrainingWindow", 'p',
			"Number of instances used for training in the beginning of the stream.", 1000, 0, Integer.MAX_VALUE);
	...
	protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
		...
		while (stream.hasMoreInstances() && ((maxInstances < 0) || (instancesProcessed < maxInstances))
			...
			if (instancesProcessed <= this.initialWindowSizeOption.getValue()) {
				...
				} else if ((this.initialWindowSizeOption.getValue() - instancesProcessed) < this.delayLengthOption
						.getValue()) {
