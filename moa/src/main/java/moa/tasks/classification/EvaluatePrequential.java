...
public class EvaluatePrequential extends AbstractEvaluatePrequential<Classifier> implements ClassificationMainTask {
	...
	public EvaluatePrequential() {
		this.learnerOption = new ClassOption("learner", 'l', "Learner to train.", Classifier.class, "trees.HoeffdingTree");
		this.evaluatorOption = new ClassOption("evaluator", 'e', "Classification performance evaluation method.",
				LearningPerformanceEvaluator.class, "WindowClassificationPerformanceEvaluator");
	}
