 ...
 * @version $Revision: 7 $
 */
public abstract class AbstractEvaluateInterleavedTestThenTrain<MLTask extends InstanceLearner> extends MainTask
	...
	public IntOption randomSeedOption = new IntOption("instanceRandomSeed", 'r',
	...
	protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
		...
		// this.learnerOption.setValueViaCLIString(this.learnerOption.getValueAsCLIString()
		// + " -r " +this.randomSeedOption);
		// this.streamOption.setValueViaCLIString(streamString + " -i " +
