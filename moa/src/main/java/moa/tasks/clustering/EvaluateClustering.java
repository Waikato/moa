...
public class EvaluateClustering extends MainTask {
	...
	public ClassOption learnerOption = new ClassOption("learner", 'l', "Clusterer to train.", AbstractClusterer.class,
			"clustream.Clustream");

	public ClassOption streamOption = new ClassOption("stream", 's', "Stream to learn from.", ClusteringStream.class,
	 ...
	 * "Performance evaluation method.", LearningPerformanceEvaluator.class,
	...
	// Given an array summarizing selected measures, set the appropriate flag
	// options
	...
	protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
		...
		BatchCmd.runBatch((ClusteringStream) getPreparedClassOption(this.streamOption),
				(AbstractClusterer) getPreparedClassOption(this.learnerOption), measureCollection,
				this.instanceLimitOption.getValue(), dumpFileOption.getValue());
