...
import moa.tasks.auxiliar.AuxiliarMainTask;
...
public class EvaluateMultipleClusterings extends AuxiliarMainTask {
	...
	public ClassOption streamOption = new ClassOption("stream", 's', "Base stream to learn from (must use FileStream).",
			ClusteringStream.class, "FileStream");
	...
	private void mergeFiles(String mergedFile, String outputFile, String tempFile) {
		...
		// System.out.println("mergeFiles "+mergedFile+" * "+outputFile+" (temp:
		// "+tempFile+")");
