...
/**
 * Task for delayed cross-validation evaluation of a classifier on a stream by testing and only
 * training with the example after the arrival of other k examples (delayed labeling).
 *
 * <p>See details in:<br>
...
public class EvaluatePrequentialDelayedCV extends ClassificationMainTask {
    ...
    public String getPurposeString() {
        return "Evaluates a classifier using delayed cross-validation evaluation by testing and"
                + " only training with the example after the arrival of other k examples"
                + " (delayed labeling) ";
    }
