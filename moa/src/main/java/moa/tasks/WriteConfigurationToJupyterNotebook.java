...
public class WriteConfigurationToJupyterNotebook extends AuxiliarMainTask {
    ...
    public ClassOption taskOption =
            new ClassOption(
                    ...
                    "Task to do.",
                    Task.class,
                    "EvaluateInterleavedTestThenTrain -l trees.HoeffdingTree -s (ArffFileStream -f"
                            + " H:/MLProject/Dataset/elecNormNew.arff) -i 1000000 -f 10000");

    public FileOption notebookOutputFile =
            new FileOption(
                    "NotebookFile",
                    'j',
                    "Destination Jupyter NotebookBuilder file.",
                    null,
                    "ipynb",
                    true);
    ...
    public FlagOption runConfig =
            new FlagOption(
                    "runConfig",
                    'r',
                    "If checked, run the configuration beside exporting the it to NotebookBuilder"
                            + " file.");
    ...
    public FlagOption exportAdvancedNotebook =
            new FlagOption(
                    ...
                    'e',
                    "Check this if you want to export the code advanced notebook");
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        try {
            ...
            if ((this.task instanceof EvaluateInterleavedTestThenTrain)
                    || (this.task instanceof EvaluatePrequential)
                    || (this.task instanceof EvaluatePrequentialCV)
                    || (this.task instanceof EvaluatePrequentialDelayed)
                    || (this.task instanceof EvaluatePrequentialDelayedCV)
                    || (this.task instanceof EvaluatePrequentialRegression)) {
                ...
                if (destFile != null) {
                    try {
                        ...
                        monitor.setCurrentActivityDescription(
                                "Writing configuration to IPYNB file");
                        ...
                        if (currentTask instanceof EvaluateInterleavedTestThenTrain) {
                            String classifier =
                                    ((EvaluateInterleavedTestThenTrain) currentTask)
                                            .learnerOption.getValueAsCLIString();
                            ((EvaluateInterleavedTestThenTrain) currentTask)
                                    .learnerOption.setValueViaCLIString(classifier);
                            ...
                            dumpFile =
                                    ((EvaluateInterleavedTestThenTrain) currentTask)
                                            .dumpFileOption.getFile();
                            randomSeed =
                                    ((EvaluateInterleavedTestThenTrain) currentTask)
                                            .randomSeedOption.getValue();
                            sampleFrequency =
                                    ((EvaluateInterleavedTestThenTrain) currentTask)
                            ...
                            String classifier =
                                    ((EvaluatePrequential) currentTask)
                                            .learnerOption.getValueAsCLIString();
                            ((EvaluatePrequential) currentTask)
                                    .learnerOption.setValueViaCLIString(classifier);
                            streamString =
                            ...
                            outputPredictionFile =
                                    ((EvaluatePrequential) currentTask)
                                            .outputPredictionFileOption.getFile();
                            sampleFrequency =
                                    ((EvaluatePrequential) currentTask)
                                            .sampleFrequencyOption.getValue();
                            instanceLimit =
                            ...
                            if (getPreparedClassOption(
                                            ((EvaluatePrequential) currentTask).evaluatorOption)
                                    instanceof WindowClassificationPerformanceEvaluator) {
                                // ((WindowClassificationPerformanceEvaluator)
                                // evaluator).setWindowWidth(widthOption.getValue());
                                if (((EvaluatePrequential) currentTask).widthOption.getValue()
                                        != 1000) {
                                    System.out.println(
                                            "DEPRECATED! Use EvaluatePrequential -e"
                                                + " (WindowClassificationPerformanceEvaluator -w "
                                                    + ((EvaluatePrequential) currentTask)
                            ...
                            if (getPreparedClassOption(
                                            ((EvaluatePrequential) currentTask).evaluatorOption)
                                    instanceof EWMAClassificationPerformanceEvaluator) {
                                // ((EWMAClassificationPerformanceEvaluator)
                                // evaluator).setalpha(alphaOption.getValue());
                                if (((EvaluatePrequential) currentTask).alphaOption.getValue()
                                        != .01) {
                                    System.out.println(
                                            "DEPRECATED! Use EvaluatePrequential -e"
                                                    + " (EWMAClassificationPerformanceEvaluator -a "
                                                    + ((EvaluatePrequential) currentTask)
                            ...
                            if (getPreparedClassOption(
                                            ((EvaluatePrequential) currentTask).evaluatorOption)
                                    instanceof FadingFactorClassificationPerformanceEvaluator) {
                            ...
                            String classifier =
                                    ((EvaluatePrequentialCV) currentTask)
                                            .learnerOption.getValueAsCLIString();
                            ((EvaluatePrequentialCV) currentTask)
                                    .learnerOption.setValueViaCLIString(classifier);
                            streamString =
                            ...
                            evaluatorString =
                                    ((EvaluatePrequentialCV) currentTask)
                                            ...
                                            .replace('\\', '/');
                            dumpFile =
                                    ((EvaluatePrequentialCV) currentTask).dumpFileOption.getFile();
                            sampleFrequency =
                                    ((EvaluatePrequentialCV) currentTask)
                                            .sampleFrequencyOption.getValue();
                            instanceLimit =
                            ...
                            randomSeed =
                                    ((EvaluatePrequentialCV) currentTask)
                                            .randomSeedOption.getValue();
                            numFolds =
                                    ((EvaluatePrequentialCV) currentTask).numFoldsOption.getValue();
                            validationMethodology =
                                    ((EvaluatePrequentialCV) currentTask)
                                            .validationMethodologyOption.getChosenIndex();

                        } else if (currentTask instanceof EvaluatePrequentialDelayed) {
                            String classifier =
                                    ((EvaluatePrequentialDelayed) currentTask)
                                            .learnerOption.getValueAsCLIString();
                            ((EvaluatePrequentialDelayed) currentTask)
                                    .learnerOption.setValueViaCLIString(classifier);
                            streamString =
                            ...
                            instanceLimit =
                                    ((EvaluatePrequentialDelayed) currentTask)
                                            .instanceLimitOption.getValue();
                            trainOnInitialWindow =
                                    ((EvaluatePrequentialDelayed) currentTask)
                                            .trainOnInitialWindowOption.isSet();
                            initialWindowSize =
                                    ((EvaluatePrequentialDelayed) currentTask)
                                            .initialWindowSizeOption.getValue();
                            delayLength =
                                    ((EvaluatePrequentialDelayed) currentTask)
                                            .delayLengthOption.getValue();
                            trainInBatches =
                                    ((EvaluatePrequentialDelayed) currentTask)
                                            .trainInBatches.isSet();
                            ...
                            if (getPreparedClassOption(
                                ...
                                // ((WindowClassificationPerformanceEvaluator)
                                // evaluator).setWindowWidth(widthOption.getValue());
                                if (((EvaluatePrequentialDelayed) currentTask)
                                                .widthOption.getValue()
                                        != 1000) {
                                    System.out.println(
                                            "DEPRECATED! Use EvaluatePrequential -e"
                            ...
                            String classifier =
                                    ((EvaluatePrequentialDelayedCV) currentTask)
                                            .learnerOption.getValueAsCLIString();
                            ((EvaluatePrequentialDelayedCV) currentTask)
                                    .learnerOption.setValueViaCLIString(classifier);
                            streamString =
                            ...
                            String classifier =
                                    ((EvaluatePrequentialRegression) currentTask)
                                            .learnerOption.getValueAsCLIString();
                            ((EvaluatePrequentialRegression) currentTask)
                                    .learnerOption.setValueViaCLIString(classifier);
                            streamString =
                            ...
                            if (getPreparedClassOption(
                                ...
                                // ((WindowClassificationPerformanceEvaluator)
                                // evaluator).setWindowWidth(widthOption.getValue());
                                if (((EvaluatePrequentialRegression) currentTask)
                                                .widthOption.getValue()
                                        != 1000) {
                                    System.out.println(
                                            "DEPRECATED! Use EvaluatePrequential -e"
                        ...
                        if (this.exportAdvancedNotebook.isSet()) {
                            ...
                            nb.addMarkdown()
                                    .addSource(
                                            "This IPYNB file was generated automatically by MOA"
                                                    + " GUI.<br>")
                                    .addSource(
                                            "Task name: "
                            ...
                            nb.addCode()
                                    ...
                                    .addSource(
                                            "import moa.classifiers."
                                                    + learnerOptionsString.getClassFullName()
                                                    + ";")
                                    .addSource(
                                            "import moa.streams."
                                                    + streamOptionsString.getClassFullName()
                                                    + ";")
                                    .addSource(
                                            "import moa.evaluation."
                                                    + evaluatorOptionsString.getClassFullName()
                                                    + ";")
                            ...
                            if ((currentTask instanceof EvaluatePrequentialCV)
                                    || (currentTask instanceof EvaluatePrequentialDelayedCV)) {
                                nb.getCellByIndex(1).addSource("import java.util.Random;");
                                nb.getLastCell()
                                        .addSource("int randomSeed =" + randomSeed + ";")
                                        .addSource("Random random = new Random(randomSeed);")
                                        /*-----------------create learner----------------- **/
                                        .addSource("int numFolds = " + numFolds + ";")
                                        .addSource(
                                                learnerOptionsString.getClassShortName()
                                                        + "[] "
                                                        + learnerOptionsString
                                                                .getClassShortName()
                                                                .substring(0, 4)
                                                                .toLowerCase()
                                                        + "Array = new "
                                        ...
                                        // Learner baseLearner = (Learner)
                                        // getPreparedClassOption(this.learnerOption);
                                        // baseLearner.resetLearning();
                                        /*--------------create stream------------**/
                                        .addSource("")
                                        .addSource(
                                                "String streamString = \"" + streamString + "\";")
                                        ...
                                        .addSource(
                                                "String evaluatorString = \""
                                                        ...
                                                        + "\";")
                                        .addSource(
                                                evaluatorOptionsString.getClassShortName()
                                                        + "[] "
                                                        + evaluatorOptionsString
                                                                .getClassShortName()
                                                                .substring(0, 4)
                                                                .toLowerCase()
                                                        + "Array = new "
                            ...
                            nb.addMarkdown().addSource("## Setting environmental parameters");
                            nb.addCode()
                                    ...
                                    .addSource(
                                            "LearningCurve learningCurve = new"
                                                    + " LearningCurve(\"learning evaluation"
                                                    + " instances\");")
                                    .addSource(
                                    ...
                                    .addSource(
                                            "                \"Unable to open immediate result"
                                                    + " file: \"  + dumpFile, ex);")
                                    .addSource("    }")
                                    .addSource("}");

                            if ((currentTask instanceof EvaluatePrequential)
                                ...
                                if (outputPredictionFile != null) {
                                    nb.getLastCell()
                                            .addSource(
                                                    "File outputPredictionFile = new File(\""
                                                            + outputPredictionFile
                                                                    .getAbsolutePath()
                                                                    .replace('\\', '/')
                                                            + "\");");
                                } else
                                    nb.getLastCell().addSource("File outputPredictionFile = null;");
                                ...
                                nb.getLastCell()
                                        ...
                                        .addSource(
                                                "            outputPredictionResultStream = new"
                                                        + " PrintStream(")
                                        .addSource(
                                                "                    new"
                                                        + " FileOutputStream(outputPredictionFile,"
                                                        + " true), true);")
                                        .addSource("        } else {")
                                        .addSource(
                                                "            outputPredictionResultStream = new"
                                        ...
                                        .addSource(
                                                "                 \"Unable to open prediction"
                                                        + " result file: \" + outputPredictionFile,"
                                                        + " ex);")
                                        .addSource("    }")
                                        .addSource("}");
                                if (currentTask instanceof EvaluatePrequentialDelayed) {
                                    ...
                                    nb.getLastCell()
                                            .addSource(
                                                    "LinkedList<Example> trainInstances = new"
                                                            + " LinkedList<Example>();");
                                }
                            } else if (currentTask instanceof EvaluatePrequentialDelayedCV) {
                                nb.getCellByIndex(1).addSource("import java.util.LinkedList;");
                                nb.getLastCell()
                                        .addSource(
                                                "LinkedList<LinkedList<Example>> trainInstances ="
                                                        + " new LinkedList<LinkedList<Example>>();")
                                        .addSource(
                                                "for(int i = 0; i < "
                                                        + learnerOptionsString
                                                                .getClassShortName()
                            ...
                            nb.getLastCell()
                                    .addSource("boolean firstDump = true;")
                                    .addSource("boolean firstPrint = true;")
                                    .addSource(
                                            "boolean preciseCPUTiming ="
                            ...
                            // begin the loop
                            nb.addMarkdown().addSource("## Testing & training, exporting result");

                            nb.addCode().addSource("DrawTable table = new DrawTable();");
                            nb.getCellByIndex(1).addSource("import moaflow.sink.DrawTable;");
                            nb.getLastCell()
                                    .addSource("System.out.println( \"Evaluating learner...\");")
                                    .addSource(
                                            "while ("
                                                    + streamOptionsString
                                                            .getClassShortName()
                                                    ...
                                                    + ".hasMoreInstances()")
                                    .addSource(
                                            "        && ((maxInstances < 0) || (instancesProcessed"
                                                    + " < maxInstances))")
                                    .addSource(
                                            "        && ((maxSeconds < 0) || (secondsElapsed <"
                                                    + " maxSeconds))) {");
                            ...
                            if (currentTask instanceof EvaluatePrequentialCV) {
                                ...
                                nb.getLastCell()
                                        ...
                                        .addSource("        int k = 1;")
                                        .addSource(
                                                "        int validationMethodology = "
                                                        + validationMethodology
                                                        + ";")
                                        .addSource("        switch (validationMethodology) {")
                                        .addSource("            case 0: //Cross-Validation;")
                                        .addSource(
                                                "                k = instancesProcessed % "
                                                        + learnerOptionsString
                                                                .getClassShortName()
                                                                .substring(0, 4)
                                                                .toLowerCase()
                                                        + "Array.length == i ? 0: 1; //Test all"
                                                        + " except one")
                                        .addSource("                break;")
                                        ...
                                        .addSource(
                                                "                k = instancesProcessed % "
                                                        + learnerOptionsString
                                                                ...
                                                                .substring(0, 4)
                                                                .toLowerCase()
                                                        + "Array.length == i ? 1: 0; //Test only"
                                                        + " one")
                                        .addSource("                break;")
                                        .addSource("        }")
                                        .addSource("        if (k > 0) {")
                                        .addSource(
                                                "            Example weightedInst = (Example)"
                                                        + " trainInst.copy();")
                                        .addSource(
                                                "           "
                                ...
                                nb.getCellByIndex(1)
                                        .addSource("import moa.core.Utils;")
                                ...
                                nb.getLastCell()
                                        ...
                                        .addSource(
                                                "    Example currentInst = "
                                                        ...
                                                        + ".nextInstance();")
                                        .addSource(
                                                "    boolean trainOnInitialWindow = "
                                                        + trainOnInitialWindow
                                                        + ";")
                                        .addSource(
                                                "    boolean trainInBatches = "
                                                        + trainInBatches
                                                        + ";")
                                        .addSource(
                                        ...
                                        .addSource(
                                                "        } else if ((initialWindowSize -"
                                                        + " instancesProcessed) < delayLength) {")
                                        .addSource(
                                        ...
                                        .addSource(
                                                "                // Do not train on the latest"
                                                        + " instance, otherwise")
                                        .addSource(
                                                "                // it would train on k+1"
                                                        + " instances")
                                        .addSource(
                                        ...
                                        //          reinstate the testInstance as it is used in
                                        // evaluator.addResult
                                        .addSource(
                                        ...
                                        .addSource(
                                                "            int trueClass = (int) ((Instance)"
                                                        + " currentInst.getData()).classValue();")
                                        .addSource(
                                                "           "
                                        ...
                                        .addSource(
                                                "                    ((Instance)"
                                                        + " testInst.getData()).classIsMissing() =="
                                                        + " true ? \" ? \" : trueClass));")
                                        .addSource("        }")
                                        .addSource(
                                                "        "
                                ...
                                nb.getLastCell()
                                        ...
                                        .addSource(
                                                "        if(delayLength <"
                                                        + " trainInstances.get(i).size()) {")
                                        .addSource(
                                                "        Example trainInstI ="
                                                        + " trainInstances.get(i).removeFirst();")
                                        .addSource(
                                                "        "
                                                        + learnerOptionsString
                                                                .getClassShortName()
                            ...
                            nb.getLastCell()
                                    ...
                                    .addSource(
                                            "        double time ="
                                                + " TimingUtils.nanoTimeToSeconds(evaluateTime -"
                                                + " evaluateStartTime);")
                                    .addSource(
                                            "        double timeIncrement ="
                                                + " TimingUtils.nanoTimeToSeconds(evaluateTime -"
                                                + " lastEvaluateStartTime);");
                            if ((currentTask instanceof EvaluatePrequentialCV)
                                    || (currentTask instanceof EvaluatePrequentialDelayedCV)) {
                                nb.getLastCell()
                                        .addSource(
                                        ...
                                        .addSource(
                                                "        double RAMHoursIncrement = "
                                                        + learnerOptionsString
                                                                ...
                                                                .substring(0, 4)
                                                                .toLowerCase()
                                                        + "Array[i].measureByteSize() / (1024.0 *"
                                                        + " 1024.0 * 1024.0); //GBs")
                                        .addSource(
                                                "        RAMHoursIncrement *= (timeIncrement /"
                                                        + " 3600.0); //Hours")
                            ...
                            nb.getLastCell()
                                    .addSource("        lastEvaluateStartTime = evaluateTime;");

                            if ((currentTask instanceof EvaluatePrequentialCV)
                                    || (currentTask instanceof EvaluatePrequentialDelayedCV)) {
                                nb.getLastCell()
                                        .addSource(
                                                "        Measurement[] modelMeasurements = new"
                                                        + " Measurement[]{")
                                        .addSource(
                                                "                                           new"
                                                        + " Measurement(")
                                        ...
                                        .addSource(
                                                "        if (("
                                                        ...
                                                        + "Array.length > 0)) {")
                                        .addSource(
                                                "            List<Measurement[]> subMeasurements ="
                                                        + " new LinkedList<>();")
                                        .addSource(
                                                "            for ("
                                                        + evaluatorOptionsString.getClassShortName()
                                        ...
                                        .addSource("        }")
                                        .addSource(
                                                "           learningCurve.insertEntry(new"
                                                    + " LearningEvaluation(measurementList.toArray(new"
                            ...
                            if ((currentTask instanceof EvaluatePrequentialCV)
                                ...
                                nb.getLastCell()
                                        .addSource(
                                                "           "
                                                    + " immediateResultStream.print(learnerString +"
                                                    + " \",\" + streamString + \",\"+"
                            ...
                            if ((currentTask instanceof EvaluatePrequentialCV)
                                ...
                                nb.getLastCell()
                                        .addSource(
                                                "           System.out.println(learnerString +"
                                                    + " \",\" + streamString + \", randomSeed = \"+"
                                                    + " Integer.toString(randomSeed) +\".\");");
                            ...
                            nb.getLastCell()
                                    ...
                                    .addSource(
                                            "       "
                                                + " System.out.print(table.bodyLine(learningCurve.entryToString(learningCurve.numEntries()"
                                                + " - 1)));")
                            ...
                            nb.getLastCell()
                                    .addSource(
                                            "double time ="
                                                + " TimingUtils.nanoTimeToSeconds(TimingUtils.getNanoCPUTimeOfCurrentThread()-"
                                                + " evaluateStartTime);")
                                    .addSource(
                                            "System.out.println(instancesProcessed + \" instances"
                         ...
                         */
                            ...
                            nb.addCode()
                                    ...
                                    .addSource(
                                            "source.numInstances.setValue(" + instanceLimit + ");")
                                    .addSource("");

                            if (currentTask instanceof EvaluateInterleavedTestThenTrain
                                    || currentTask instanceof EvaluatePrequential
                                    || currentTask instanceof EvaluatePrequentialCV
                                    || currentTask instanceof EvaluatePrequentialDelayed
                                    || currentTask instanceof EvaluatePrequentialDelayedCV) {

                                nb.getLastCell()
                                        .addSource(
                                                "EvaluateClassifier eval = new"
                                                        + " EvaluateClassifier();")
                            ...
                            nb.getLastCell()
                                    .addSource("eval.setEvaluator(evaluatorString);")
                                    .addSource("eval.everyNth.setValue(" + sampleFrequency + ");")
                                    .addSource("source.subscribe(eval);")
                                    .addSource("")
                                    .addSource(
                                            "MeasurementTableSawPlot plot = new"
                                                    + " MeasurementTableSawPlot();");
                            if (currentTask instanceof EvaluateInterleavedTestThenTrain
                                    || currentTask instanceof EvaluatePrequential
                                    || currentTask instanceof EvaluatePrequentialDelayed) {
                                nb.getLastCell()
                                        .addSource(
                                                "plot.measurement.setValue(\"classifications"
                                                        + " correct (percent)\");");
                                ...
                                nb.getLastCell()
                                        .addSource(
                                                "plot.measurement.setValue(\"[avg] classifications"
                                                        + " correct (percent)\");");
                            } else if (currentTask instanceof EvaluatePrequentialRegression) {
                                nb.getLastCell()
                                        .addSource(
                                                "plot.measurement.setValue(\"mean absolute"
                                                        + " error\");");
                            }
                            nb.getLastCell()
                                    .addSource("plot.maxPoints.setValue(-1);")
                                    .addSource("eval.subscribe(plot);")
                                    .addSource("")
                                    .addSource(
                                            "OutputLearningCurve curve = new"
                                                    + " OutputLearningCurve();")
            ...
            if (this.runConfig.isSet()) result = this.task.doTask(monitor, repository);
            else if (((MainTask) this.task).outputFileOption != null)
                result =
                        "If you want to save the task result, please tick the runConfig check box"
                                + " first.";
        } catch (Exception ex) {
            throw new RuntimeException("Failed implementing task ", ex);
        }
