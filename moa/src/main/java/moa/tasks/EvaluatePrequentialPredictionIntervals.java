...
public class EvaluatePrequentialPredictionIntervals extends RegressionMainTask {
    ...
    //            "Learner to train.", Regressor.class,
    // "moa.classifiers.meta.AdaptiveRandomForestRegression");

    public ClassOption learnerOption =
            new ClassOption(
                    "interval",
                    'p',
                    "Prediction Interval method to use",
                    PredictionIntervalLearner.class,
                    "moa.classifiers.predictioninterval.MVEPredictionInterval");
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        PredictionIntervalLearner intervalLearner =
                (PredictionIntervalLearner) getPreparedClassOption(this.learnerOption);
        ExampleStream stream = (ExampleStream) getPreparedClassOption(this.streamOption);
        PredictionIntervalPerformanceEvaluator evaluator =
                (PredictionIntervalPerformanceEvaluator)
        ...
        //                System.out.println("DEPRECATED! Use EvaluatePrequential -e
        // (WindowClassificationPerformanceEvaluator -w " + widthOption.getValue() + ")");
        ...
        //                System.out.println("DEPRECATED! Use EvaluatePrequential -e
        // (EWMAClassificationPerformanceEvaluator -a " + alphaOption.getValue() + ")");
        //                return learningCurve;
        //            }
        //        }
        ...
        //            if (alphaOption.getValue() != .01) {
        //                System.out.println("DEPRECATED! Use EvaluatePrequential -e
        // (FadingFactorClassificationPerformanceEvaluator -a " + alphaOption.getValue() + ")");
        //                return learningCurve;
        //            }
        //        }
        // End New for prequential methods
        ...
        if (outputPredictionFile != null) {
            try {
                ...
                outputPredictionResultStream.println(
                        "lower bound, prediction, upper bound, true value");
            } catch (Exception ex) {
        ...
        while (stream.hasMoreInstances()
            ...
            //            Prediction prediction = learner instanceof PredictionIntervalLearner ?
            // ((PredictionIntervalLearner)
            //                    learner).getPredictionForInstance(testInst) : new Prediction(new
            // double[]{0,0,0}) ;
            ...
            if (outputPredictionFile != null) {
                ...
                if (prediction.length == 3)
                    ...
                    outputPredictionResultStream.println(
                            "Prediction Interval Not Available:" + trueClass);
            }
