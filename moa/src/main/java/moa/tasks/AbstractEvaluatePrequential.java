 ...
 * @version $Revision: 7 $
 */
public abstract class AbstractEvaluatePrequential<MLTask extends InstanceLearner> extends MainTask {
    ...
    public AbstractEvaluatePrequential(Class<MLTask> type, String defaultCLIString) {
    ...
    public abstract void printPrediction(PrintStream print, Instance inst, Prediction prediction);
}
