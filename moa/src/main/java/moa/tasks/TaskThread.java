...
public class TaskThread extends Thread {
	...
	public double getCPUSecondsElapsed() {
		...
		if (this.currentStatus == Status.NOT_STARTED) {
			...
			secondsElapsed = TimingUtils
					.nanoTimeToSeconds(TimingUtils.getNanoCPUTimeOfThread(getId()) - this.taskStartTime);
		}
	...
	public boolean isComplete() {
		return ((this.currentStatus == Status.CANCELLED) || (this.currentStatus == Status.COMPLETED)
				|| (this.currentStatus == Status.FAILED));
	}
