 ...
 * @version $Revision: 7 $
 */
public class EvaluatePrequential extends AbstractEvaluatePrequential<MultiTargetRegressor> implements MultiTargetRegressionMainTask {
    ...
    public EvaluatePrequential() {
		...
		this.evaluatorOption = new ClassOption("evaluator", 'e',
					"Multi target regression performance evaluation method.",
