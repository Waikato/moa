...
public class EvaluatePrequentialMultiTargetSemiSuper extends MainTask {
    ...
    public ClassOption evaluatorOption = new ClassOption("evaluator", 
                'e',"Classification performance evaluation method.",MultiTargetRegressionPerformanceEvaluator.class,"BasicMultiTargetPerformanceEvaluator");
