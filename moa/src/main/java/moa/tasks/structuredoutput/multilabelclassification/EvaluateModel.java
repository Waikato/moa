 ...
 * @version $Revision: 7 $
 */
public class EvaluateModel extends AbstractEvaluateModel<MultiLabelClassifier>
	...
	public ClassOption modelOption = new ClassOption("model", 'm', "Learner to evaluate.", MultiLabelClassifier.class,
	...
	public IntOption maxInstancesOption = new IntOption("maxInstances", 'i', "Maximum number of instances to test.",
	...
	public EvaluateModel(Classifier model, InstanceStream stream, LearningPerformanceEvaluator evaluator,
			int maxInstances) {
	...
	public Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
		...
		while (stream.hasMoreInstances() && ((maxInstances < 0) || (instancesProcessed < maxInstances))) {
			...
			double[] prediction = model.getPredictionForInstance(testInst).asDoubleArray();
