...
/**
 * Task for evaluating a classifier on a delayed stream by testing and only training with the
 * example after k other examples (delayed labeling).
 *
 * <p>See details in:<br>
 ...
 * classification. In Machine Learning, DOI: 10.1007/s10994-017-5642-8, Springer, 2017.<br>
 *
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        while (stream.hasMoreInstances()
            ...
            if (instancesProcessed <= this.initialWindowSizeOption.getValue()) {
                ...
                } else if ((this.initialWindowSizeOption.getValue() - instancesProcessed)
                        < this.delayLengthOption.getValue()) {
