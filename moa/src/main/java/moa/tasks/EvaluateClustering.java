...
public class EvaluateClustering extends AuxiliarMainTask {
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        BatchCmd.runBatch(
                (ClusteringStream) getPreparedClassOption(this.streamOption),
        ...
        LearningCurve learningCurve =
                new LearningCurve(
                        "EvaluateClustering does not support custom output file (> [filename]).\n"
                                + "Check out the dump file to see the results (if you haven't"
                                + " specified, dumpClustering.csv by default).");
