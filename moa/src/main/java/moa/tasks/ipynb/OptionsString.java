...
/**
 * This class get input string of learner, stream and evaluator then process them the output will be
 * name of learner, stream, or evaluator besides their options
 *
...
public class OptionsString {
    ...
    public String generateOptionsString() {
        StringBuilder str =
                new StringBuilder(this.getClassShortName())
                        .append(" ")
    ...
    public void createOptionsList() {
            ...
            if (i >= 0) {
                ...
                if (tempClassOptionsString.length() == 0) {
                    ...
                    Pair<String, String> optionPair =
                            new Pair<String, String>(String.valueOf(cliChar), optionValue);
                                ...
                                case ')':
                                    {
                                        ...
                                        if (closeBracket == openBracket) {
                                            tempClassOptionsString =
                                                    tempClassOptionsString.substring(k + 1).trim();
                                            optionValue = temp.toString().trim();
                                            optionValue =
                                                    optionValue.substring(
                                                            1, optionValue.length() - 1);
                                            Pair<String, String> optionPair =
                                                    new Pair<String, String>(
                                                            String.valueOf(cliChar), optionValue);
                                            this.outputClassObjectOptions.add(optionPair);
                                            OptionsString subObject =
                                                    new OptionsString(optionValue);
                                        }
                                        break;
                                    }
                            }
        ...
        } else this.classShortName = this.classFullName;
    }
}
