...
public class EvaluatePeriodicHeldOutTest extends ClassificationMainTask {
    ...
    public IntOption testSizeOption =
            new IntOption(
                    "testSize", 'n', "Number of testing examples.", 1000000, 0, Integer.MAX_VALUE);

    public IntOption trainSizeOption =
            new IntOption(
                    "trainSize",
                    'i',
    ...
    public IntOption trainTimeOption =
            new IntOption(
                    "trainTime",
                    't',
                    "Number of training seconds.",
                    10 * 60 * 60,
                    0,
                    Integer.MAX_VALUE);
    ...
    public FlagOption cacheTestOption =
            new FlagOption("cacheTest", 'c', "Cache test instances in memory.");
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        if (this.cacheTestOption.isSet()) {
            ...
            Instances testInstances =
                    new Instances(stream.getHeader(), this.testSizeOption.getValue());
            while (testInstances.numInstances() < testSize) {
                ...
                if (testInstances.numInstances() % INSTANCES_BETWEEN_MONITOR_UPDATES == 0) {
                    ...
                    monitor.setCurrentActivityFractionComplete(
                            (double) testInstances.numInstances()
        ...
        while ((this.trainSizeOption.getValue() < 1
            ...
            double lastTrainTime =
                    TimingUtils.nanoTimeToSeconds(
                            TimingUtils.getNanoCPUTimeOfCurrentThread() - trainStartTime);
            ...
            double testTime =
                    TimingUtils.nanoTimeToSeconds(
                            TimingUtils.getNanoCPUTimeOfCurrentThread() - testStartTime);
            ...
            measurements.add(
                    new Measurement("total train speed", instancesProcessed / totalTrainTime));
            ...
            measurements.add(
                    new Measurement("test speed", this.testSizeOption.getValue() / testTime));
