            ...
            if (ownClusters.size() > 0) {
                ...
                for (int p1 = 0; p1 < points.size(); p1++) {
                    ...
                    if (p1 != p) {
                        ...
                        // What is the purpose of this check anyway? Class label is not used for
                ...
                silhCoeff += silhP;
                totalCount++;
                // System.out.println(point.getTimestamp()+" Silh "+silhP+" / "+avgDistanceOwn+"
                // "+minAvgDistanceOther+" (C"+minIndex+")");
            }
        }
        if (totalCount > 0) silhCoeff /= (double) totalCount;
