...
import moa.evaluation.evaluators.WindowClassificationPerformanceEvaluator.WindowEstimator;
 ...
 * @version $Revision: 1 $
 */
public class ALWindowClassificationPerformanceEvaluator extends WindowClassificationPerformanceEvaluator
	 ...
	 * @param labelAcquired bool type which indicates if trainInst was acquired by
	 *                      the active learner
	 */
	@Override
	...
	public Measurement[] getPerformanceMeasurements() {
		...
		measurements[measurements.length - 2] = new Measurement("Abs Number of Label Acquisitions",
				getAbsNumOfAcqInst());
		measurements[measurements.length - 1] = new Measurement("Rel Number of Label Acquisitions",
				getRelNumOfAcqInst());
		return measurements;
	}
