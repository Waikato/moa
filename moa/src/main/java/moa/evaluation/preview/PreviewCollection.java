...
public class PreviewCollection<CollectionElementType extends Preview> extends Preview {
    ...
    public void setPreview(int previewIndex, CollectionElementType preview)
    ...
    public double[] getEntryData(int entryIndex) {
        ...
        double[] subPreviewEntry =
                subPreviews.get(subPreviewIndex).getEntryData(subPreviewEntryIndex);
