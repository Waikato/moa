 ...
 * <B>Emo Welzl</B> "Smallest enclosing disks (balls and Ellipsoid)" and the
 * work of <B>Jack Ritter</B> on "Efficient Bounding Spheres" at<br>
 ...
 * 
 * Original Java port from Paolo Perissinotto for Jpatch Project by Sascha
 * Ledinsky found at http://forum.jpatch.com/viewtopic.php?f=3&t=919
 *
 * @author Paolo Perissinotto for Jpatch Project by <B>Sascha Ledinsky</B>
 *
 * @version 1.0 {@literal Date: 2007/11/18 21:57}
 *
 *          used for moa for calculating most compact sphere cluster modified by
 *          Timm Jansen (moa@cs.rwth-aachen.de) to be used with high dimensional
 *          points
 *
 */
...
public class Miniball {
	 ...
	 * Always use at the end of a Miniball use if you want to reuse later the
	 * Miniball object
	 *
	 */
	public void clear() {
