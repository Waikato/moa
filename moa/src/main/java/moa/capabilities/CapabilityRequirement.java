...
public class CapabilityRequirement {
	...
	/**
	 * The capabilities to assume a class has if it does not implement the
	 * CapabilitiesHandler interface.
	 */
	public static final ImmutableCapabilities NON_HANDLER_CAPABILITIES = new ImmutableCapabilities(
			Capability.VIEW_STANDARD, Capability.VIEW_LITE);

	/** The function to use to test if the requirement is met. */
	private Predicate<Capabilities> m_Test;

	/**
	 * Creates a capabilities requirement with the given predicate as its method of
	...
	/**
	 * Creates a requirement that a given set of capabilities have at least on of
	 * the specified capabilities.
	 *
	 * @param capabilities The capabilities that a tested set must have at least one
	 *                     of.
	 * @return The requirement.
	 */
	...
	/**
	 * Creates a requirement that a given set of capabilities must have the given
	 * capability.
	 *
