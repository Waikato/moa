...
public interface CapabilitiesHandler {
    ...
    /**
     * Gets the capabilities of the object. Should be overridden if the object's capabilities can
     * change.
     *
    ...
    /**
     * Defines the set of capabilities the object has. Should be overridden if the object's
