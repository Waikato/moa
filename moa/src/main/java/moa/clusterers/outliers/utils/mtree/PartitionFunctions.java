...
/** Some pre-defined implementations of {@linkplain PartitionFunction partition functions}. */
public final class PartitionFunctions {
    ...
    /**
     * A {@linkplain PartitionFunction partition function} that tries to distribute the data objects
     * equally between the promoted data objects, associating to each promoted data objects the
    ...
    public static class BalancedPartition<DATA> implements PartitionFunction<DATA> {
        ...
        public Pair<Set<DATA>> process(
            ...
            Pair<Set<DATA>> partitions =
                    new Pair<Set<DATA>>(new HashSet<DATA>(), new HashSet<DATA>());
