...
/** Some pre-defined implementations of {@linkplain DistanceFunction distance functions}. */
public final class DistanceFunctions {
    ...
    /**
     * Creates a cached version of a {@linkplain DistanceFunction distance function}. This method is
     * used internally by {@link MTree} to create a cached distance function to pass to the
     * {@linkplain SplitFunction split function}.
     *
     ...
     *
     * @see <a href="http://en.wikipedia.org/wiki/Euclidean_space">"Euclidean Space" article at
     *     Wikipedia</a>
     */
    public interface EuclideanCoordinate {
         ...
         *
         * @param index The index of the component. Must be less than {@link #dimensions()}.
         */
        double get(int index);
    }

    /**
     * Calculates the distance between two {@linkplain EuclideanCoordinate euclidean coordinates}.
     */
    ...
    /**
     * A {@linkplain DistanceFunction distance function} object that calculates the distance between
     * two {@linkplain EuclideanCoordinate euclidean coordinates}.
     */
    public static final DistanceFunction<EuclideanCoordinate> EUCLIDEAN =
            new DistanceFunction<DistanceFunctions.EuclideanCoordinate>() {
                @Override
    ...
    /**
     * A {@linkplain DistanceFunction distance function} object that calculates the distance between
     * two coordinates represented by {@linkplain java.util.List lists} of {@link
     * java.lang.Integer}s.
     */
    public static final DistanceFunction<List<Integer>> EUCLIDEAN_INTEGER_LIST =
            new DistanceFunction<List<Integer>>() {
                @Override
                public double calculate(List<Integer> data1, List<Integer> data2) {
                    ...
                    ;
                    IntegerListEuclideanCoordinate coord1 =
                            new IntegerListEuclideanCoordinate(data1);
                    IntegerListEuclideanCoordinate coord2 =
                            new IntegerListEuclideanCoordinate(data2);
                    return DistanceFunctions.euclidean(coord1, coord2);
                }
            };
    ...
    public static final DistanceFunction<List<Double>> EUCLIDEAN_DOUBLE_LIST =
            new DistanceFunction<List<Double>>() {
                @Override
