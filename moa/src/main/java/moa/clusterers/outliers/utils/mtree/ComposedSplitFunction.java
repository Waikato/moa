...
/**
 * A {@linkplain SplitFunction split function} that is defined by composing a {@linkplain
 * PromotionFunction promotion function} and a {@linkplain PartitionFunction partition function}.
 *
...
public class ComposedSplitFunction<DATA> implements SplitFunction<DATA> {
    ...
    /**
     * The constructor of a {@link SplitFunction} composed by a {@link PromotionFunction} and a
     * {@link PartitionFunction}.
     */
    public ComposedSplitFunction(
            PromotionFunction<DATA> promotionFunction, PartitionFunction<DATA> partitionFunction) {
        this.promotionFunction = promotionFunction;
        this.partitionFunction = partitionFunction;
    }

    @Override
    public SplitResult<DATA> process(
            Set<DATA> dataSet, DistanceFunction<? super DATA> distanceFunction) {
