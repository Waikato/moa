...
public class AnyOut extends MyBaseOutlierDetector {
    ...
    public String getObjectInfo(Object o) {
        ...
        sb.append(
                "<tr><td><b>X, Y:</b></td><td>"
                        + String.format("%.4f", features[0])
                        + ", "
                        + String.format("%.4f", features[1])
                        + "</td></tr>");
        sb.append(
                "<tr><td><b>Oscore:</b></td><td>"
                        + String.format("%.4f", anyout.getOutlierScore(id))
                        + "</td></tr>");
        sb.append(
                "<tr><td><b>Conf:</b></td><td>"
                        + String.format("%.4f", anyout.getConfidence(id))
                        + "</td></tr>");
        sb.append("</table>");
        sb.append("</html>");
