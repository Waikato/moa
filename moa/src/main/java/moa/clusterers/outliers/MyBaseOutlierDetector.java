...
public abstract class MyBaseOutlierDetector extends AbstractClusterer {
    ...
    public abstract static class OutlierNotifier {
    ...
    public IntOption windowSizeOption =
            new IntOption("windowSize", 'w', "Size of the window.", 1000);
    ...
    public void SetUserInfo(
            boolean bShowProgress, boolean bTrace, PrintMsg logPrinter, int iProgressInterval) {
    ...
    protected void Println(String s) {
        if (myOut != null) myOut.println(s);
    }

    protected void Print(String s) {
        if (myOut != null) myOut.print(s);
    }

    protected void Printf(String fmt, Object... args) {
        if (myOut != null) myOut.printf(fmt, args);
    }
