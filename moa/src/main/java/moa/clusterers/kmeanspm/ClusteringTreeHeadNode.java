...
public class ClusteringTreeHeadNode extends ClusteringTreeNode {
     ...
     * @param numProjections the number of projections to use for the nearest neighbor search
    ...
    public ClusteringTreeNode nearestChild(double[] pointA) {
        ...
        // for (int i = -1; i <= 1; i++) {
        List<ClusteringTreeNode> currentBucket =
                this.buckets.get(minBucketProjection).get(bucketNumber); // + i);
