 ...
 *
 * <p>Citation: Rasmus Pagh, Flemming Friche Rodler: Cuckoo Hashing. ESA 2001: 121-133
 *
...
public class CuckooHashing<T> {
     ...
     *
     * @param startHashSize size of the hash function at the beginning (must be smaller than 31)
     ...
     * @param rehash if <code>true</code> the hash table will be rebuild when the stash became too
     *     big.
     */
    ...
    /**
     * Removes all of the elements from this hash table. The hash table will be empty after this
     * call returns.
     */
    public void clear() {
