...
public class Metric {
    ...
    /**
     * Calculates the squared Euclidean distance of two points. Starts at dimension offset + 1 of
     * pointB.
     *
     * @param pointA first point
     * @param pointB second point
     * @param offsetB start dimension - 1 of pointB
    ...
    /**
     * Calculates the squared Euclidean distance of the first point divided by a scalar and another
     * second point.
     *
     * @param pointA first point
     * @param dA scalar
    ...
    /**
     * Calculates the Euclidean distance of the first point divided by a scalar and another second
     * point.
     *
     * @param pointA first point
     * @param dA scalar
    ...
    /**
     * Calculates the squared Euclidean distance of the first point divided by a first scalar and
     * another second point divided by a second scalar.
     *
     * @param pointA first point
     * @param dA first scalar
     * @param pointB second point
     * @param dB second scalar
     * @return the squared Euclidean distance
     */
    public static double distanceWithDivisionSquared(
            double[] pointA, double dA, double[] pointB, double dB) {
        assert (pointA.length == pointB.length);
        double distance = 0.0;
        for (int i = 0; i < pointA.length; i++) {
    ...
    /**
     * Calculates the Euclidean distance of the first point divided by a first scalar and another
     * second point divided by a second scalar.
     *
     * @param pointA first point
     * @param dA first scalar
     * @param pointB second point
     ...
     * @return the Euclidean distance
     */
    public static double distanceWithDivision(
            double[] pointA, double dA, double[] pointB, double dB) {
    ...
    /**
     * Calculates the dot product of the addition of the first and the second point with the third
     * point.
     *
     * @param pointA1 first point
     * @param pointA2 second point
     * @param pointB third point
     * @return the dot product
     */
    public static double dotProductWithAddition(
            double[] pointA1, double[] pointA2, double[] pointB) {
    ...
    /**
     * Calculates the dot product of the addition of the first and the second point with the
     * addition of the third and the fourth point.
     *
     * @param pointA1 first point
     * @param pointA2 second point
     * @param pointB1 third point
     * @param pointB2 fourth point
     * @return the dot product
     */
    public static double dotProductWithAddition(
            double[] pointA1, double[] pointA2, double[] pointB1, double[] pointB2) {
        assert (pointA1.length == pointA2.length
                && pointB1.length == pointB2.length
                && pointA1.length == pointB1.length);
        double product = 0.0;
        for (int i = 0; i < pointA1.length; i++) {
