...
public class ClusteringTreeNode extends AbstractMOAObject {
     ...
     *
     * @param center representation of the ClusterFeature
     * @param cf the ClusterFeature
     */
     ...
     *
     * @param clustering the Clustering to add the ClusterFeatures too.
    ...
    /**
     * Adds all clustering centers of the ClusterFeatures of the tree with this node as the root to
     * a List of points.
     *
     * @param clustering the List to add the clustering centers too.
    ...
    /**
     * Writes all clustering centers of the ClusterFeatures of the tree with this node as the root
     * to a given stream.
     *
     ...
     *
     * @param center the representation of the ClusteringFeature to set
     */
     ...
     *
     * @param pointA to find the nearest child for
