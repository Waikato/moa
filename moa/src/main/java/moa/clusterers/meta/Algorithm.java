...
public class Algorithm {
    ...
    public Algorithm(
            ...
            double lambda,
            double reset,
            boolean keepCurrentModel,
            boolean reinitialiseWithClusters,
            int verbose) {
        ...
        if (keepCurrentModel) {
            try {
                ...
                if (verbose >= 2) {
                    System.out.println(
                            "Copy failed for "
                                    + x.clusterer.getCLICreationString(Clusterer.class)
    ...
    public void adjustAlgorithm(
            boolean keepCurrentModel, boolean reinitialiseWithClusters, int verbose) {
        ...
        if (keepCurrentModel) {
            ...
            try {
                ...
                if (verbose >= 2) {
                    System.out.println(
                            "Changed: " + this.clusterer.getCLICreationString(Clusterer.class));
                }
            ...
            if (verbose >= 2) {
                System.out.println(
                        "Initialise: " + this.clusterer.getCLICreationString(Clusterer.class));
            }
