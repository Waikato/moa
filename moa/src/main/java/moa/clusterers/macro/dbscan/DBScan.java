...
public class DBScan extends AbstractMacroClusterer {
    ...
    private ArrayList<DenseMicroCluster> expandCluster(
            DenseMicroCluster dmc,
    ...
    private List<DenseMicroCluster> getNeighbourhood(
            DenseMicroCluster mc, Vector<DenseMicroCluster> dbmc) {
    ...
    public Clustering getClustering(Clustering microClusters) {
        if (microClusters != null && microClusters.size() != 0) {
            ...
            ArrayList<ArrayList<DenseMicroCluster>> clusters =
                    new ArrayList<ArrayList<DenseMicroCluster>>();
                ...
                if (!dmc.isVisited()) {
                    ...
                    if (neighbours.size() >= mMinPts) {
                        ArrayList<DenseMicroCluster> cluster =
                                expandCluster(
                                        dmc, neighbours, new ArrayList<DenseMicroCluster>(), dbmc);
