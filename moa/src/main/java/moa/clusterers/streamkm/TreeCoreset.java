...
public class TreeCoreset {
    ...
    protected class treeNode {
         ...
         */
        public treeNode(
                Point[] setA, Point[] setB, int n_1, int n_2, Point centre, int centreIndex) {
         ...
         *
         * <p>1. only the centre of the treenode is used as a centre
         *
         * <p>2. works on arrays of pointers instead on arrays of points
         *
         * <p>3. stores the cost in the treenode
         */
                ...
                for (l = 0; l < this.points[i].dimension; l++) {
                    ...
                    if (this.points[i].weight != 0.0) {
                        centroidCoordinatePoint =
                                this.points[i].coordinates[l] / this.points[i].weight;
                    } else {
    ...
    /**
     * splits the parent node and creates two child nodes (one with the old centre and one with the
     * new one)
     */
    ...
    void unionTreeCoreset(
        ...
        treeNode root =
                new treeNode(setA, setB, n_1, n_2, centres[choosenPoints], choosenPoints); // ??
        choosenPoints = 1;
