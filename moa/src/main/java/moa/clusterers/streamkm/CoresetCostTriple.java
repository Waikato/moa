...
/**
 * CoresetCostTriple is a wrapper that allows the lloydPlusPlus method in StreamKM to return the
 * coresetCentres, radii of the associated clusters and the cost associated with the coreset.
 *
