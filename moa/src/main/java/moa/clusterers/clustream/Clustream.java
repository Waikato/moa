...
/**
 * Citation: CluStream: Charu C. Aggarwal, Jiawei Han, Jianyong Wang, Philip S. Yu: A Framework for
 * Clustering Evolving Data Streams. VLDB 2003: 81-92
 */
public class Clustream extends AbstractClusterer {
    ...
    public IntOption maxNumKernelsOption =
            new IntOption("maxNumKernels", 'k', "Maximum number of micro kernels to use.", 100);
