...
public class MultiTargetRegressionTaskManagerPanel extends JPanel {
		...
		this.configureTaskButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				String newTaskString = ClassOptionSelectionPanel.showSelectClassDialog(
						MultiTargetRegressionTaskManagerPanel.this, "Configure task",
						MultiTargetRegressionMainTask.class, MultiTargetRegressionTaskManagerPanel.this.currentTask
								.getCLICreationString(MultiTargetRegressionMainTask.class),
						null);
				setTaskString(newTaskString);
			}
		});
	...
	public void setTaskString(String cliString, boolean storePreference) {
		try {
			this.currentTask = (MultiTargetRegressionMainTask) ClassOption.cliStringToObject(cliString,
					MultiTargetRegressionMainTask.class, null);
			String taskText = this.currentTask.getCLICreationString(MultiTargetRegressionMainTask.class);
