...
import moa.tasks.structuredoutput.multitargetregression.EvaluatePrequential;
import moa.tasks.structuredoutput.multitargetregression.MultiTargetRegressionMainTask;
 ...
 * @version $Revision: 7 $
 */
public class MultiTargetRegressionTaskManagerPanel extends JPanel {
    ...
    protected class TaskTableModel extends AbstractTableModel {
        ...
        public int getRowCount() {
            return MultiTargetRegressionTaskManagerPanel.this.taskList.size();
        }

        @Override
        public Object getValueAt(int row, int col) {
            TaskThread thread = MultiTargetRegressionTaskManagerPanel.this.taskList.get(row);
            switch (col) {
                case 0:
                    return ((OptionHandler) thread.getTask()).getCLICreationString(MultiTargetRegressionMainTask.class);
                case 1:
    ...
    protected MultiTargetRegressionMainTask currentTask = new EvaluatePrequential();
    ...
    public MultiTargetRegressionTaskManagerPanel() {
        // Read current task preference
        prefs = Preferences.userRoot().node(this.getClass().getName());
        currentTask = new EvaluatePrequential();
        String taskText = this.currentTask.getCLICreationString(MultiTargetRegressionMainTask.class);
        ...
        this.configureTaskButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                String newTaskString = ClassOptionSelectionPanel.showSelectClassDialog(MultiTargetRegressionTaskManagerPanel.this,
                        "Configure task", MultiTargetRegressionMainTask.class,
                        MultiTargetRegressionTaskManagerPanel.this.currentTask.getCLICreationString(MultiTargetRegressionMainTask.class),
                        null);
                setTaskString(newTaskString);
            }
        });
        this.runTaskButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                runTask((Task) MultiTargetRegressionTaskManagerPanel.this.currentTask.copy());
            }
        });
        ...
        javax.swing.Timer updateListTimer = new javax.swing.Timer(
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                MultiTargetRegressionTaskManagerPanel.this.taskTable.repaint();
            }
        });
    ...
    public void setTaskString(String cliString, boolean storePreference) {    
        try {
            this.currentTask = (MultiTargetRegressionMainTask) ClassOption.cliStringToObject(
                    cliString, MultiTargetRegressionMainTask.class, null);
            String taskText = this.currentTask.getCLICreationString(MultiTargetRegressionMainTask.class);
    ...
    public void taskSelectionChanged() {
        ...
        if (selectedTasks.length == 1) {
            setTaskString(((OptionHandler) selectedTasks[0].getTask()).getCLICreationString(MultiTargetRegressionMainTask.class));
    ...
    public void saveLogSelectedTasks() {
        ...
        TaskThread[] selectedTasks = getSelectedTasks();
        for (TaskThread thread : selectedTasks) {
            tasksLog += ((OptionHandler) thread.getTask()).getCLICreationString(MultiTargetRegressionMainTask.class) + "\n";
        }
    ...
    private static void createAndShowGUI() {
        ...
        JPanel panel = new MultiTargetRegressionTaskManagerPanel();
