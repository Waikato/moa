...
/**
 * EditComponent for the {@link ClassOptionWithListenerOption}. When its state is changed, the
 * changes are directly applied to the corresponding Option so that potential listeners can be
 * notified and updates can be processed.
 *
 * @author Cornelius Styp von Rekowski (cornelius.styp@ovgu.de)
 * @version $Revision: 1 $
 */
        ...
        this.addChangeListener(
                new ChangeListener() {
                    ...
                    public void stateChanged(ChangeEvent e) {
                        if (!ClassOptionWithListenerOptionEditComponent.this
                                .textField
                                .getText()
                                .isEmpty()) {
