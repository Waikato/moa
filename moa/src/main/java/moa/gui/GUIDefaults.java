...
public class GUIDefaults implements Serializable {
	...
	/**
	 * returns an array with the classnames of all the additional panels to display
	 * as tabs in the GUI.
	 *
	...
	/**
	 * returns an array with the classnames of all default tabs to display as tabs
	 * in the GUI.
	 *
	 * @return the classnames
	 */
