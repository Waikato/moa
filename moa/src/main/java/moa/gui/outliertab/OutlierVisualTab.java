...
public class OutlierVisualTab extends javax.swing.JPanel
    ...
    public void toggleVisualizer(boolean internal) {
        ...
        if (internal) outlierSetupTab.toggleRunMode();
    }
    ...
    private void initComponents() {
        ...
        splitVisual.addComponentListener(
        ...
        checkboxDrawOutliers.addActionListener(
                new java.awt.event.ActionListener() {
                    @Override
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        checkboxWaitWinFull.addActionListener(
                new java.awt.event.ActionListener() {
                    @Override
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        graphPanel.setBorder(
                javax.swing.BorderFactory.createTitledBorder("Process time per object"));
        ...
        panelEvalOutput.addComponentListener(
                new ComponentListener() {
                    @Override
                    public void componentResized(ComponentEvent ce) {
    ...
    private void buttonRedrawMouseClicked(
            java.awt.event.MouseEvent evt) { // GEN-FIRST:event_buttonRedrawMouseClicked
    ...
    private void checkboxDrawOutlierActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_checkboxDrawOutlierActionPerformed
        if (visualizer == null) return;
    ...
    private void checkboxWaitWinFullActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_checkboxWaitWinFullActionPerformed
        if (visualizer == null) return;
