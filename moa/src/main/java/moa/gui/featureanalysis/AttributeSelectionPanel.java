...
/**
 * A sub panel in visualizeFeatures tab. It shows all the attributes in a data stream so that a user
 * selects to show the attribute's statistical information, graphs. This panel refers to
