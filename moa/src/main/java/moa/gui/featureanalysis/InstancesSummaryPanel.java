...
/**
 * This panel just displays relation name, number of instances, and number of attributes. This panel
 * refers to weka.gui.InstancesSummaryPanel.
 *
...
public class InstancesSummaryPanel extends JPanel {
    ...
    /**
     * Whether to display 0 or ? for the number of instances in cases where a dataset has only
     * structure. Depending on where this panel is used from, the user may have loaded a dataset
     * with no instances or a Loader that can read incrementally may be being used (in which case we
     * don't know how many instances are in the dataset... yet).
     */
    ...
    /**
     * Set whether to show zero instances as unknown (i.e. "?" rather than zero). This is useful if
     * header information has been read and the instances themselves will be loaded incrementally.
     *
    ...
    /**
     * Get whether to show zero instances as unknown (i.e. "?" rather than zero). This is useful if
     * header information has been read and the instances themselves will be loaded incrementally.
     *
