...
/**
 * This panel displays summary statistics about an attribute: name, type number/% of missing/unique
 * values, number of distinct values. For numeric attributes gives some other stats (mean/std dev),
 * for nominal attributes gives counts for each attribute value. This panel refers to
