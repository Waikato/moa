 ...
 * @version $Revision: 7 $
 */
public class MultiLabelClassificationTabPanel extends AbstractTabPanel {

	private static final long serialVersionUID = 1L;

	protected MultiLabelClassificationTaskManagerPanel taskManagerPanel;

	protected PreviewPanel previewPanel;

	public MultiLabelClassificationTabPanel() {
		this.taskManagerPanel = new MultiLabelClassificationTaskManagerPanel();
	...
	public String getTabTitle() {
		return "Multi-label classification"; // "Learning";
	}
