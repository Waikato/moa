...
/**
 * The main class for the MOA gui. Lets the user configure tasks, learners, streams, and perform
    ...
    private void initGUI() {
        ...
        for (int i = 0; i < tabs.length; i++) {
            try {
                ...
                // setup panel
                AbstractTabPanel tabPanel =
                        (AbstractTabPanel) Class.forName(classname).newInstance();
            ...
            javax.swing.SwingUtilities.invokeLater(
                    new Runnable() {
                        ...
                        public void run() {
                            ...
                            // Display the window.
                            frame.setSize(
                                    GUIDefaults.getFrameWidth(), GUIDefaults.getFrameHeight());
