...
//        out.close();
	...
	/**
	 * Generates a latex summary, in which the rows are the datasets and the columns
	 * the algorithms.
	 */
...
//            out.close();
	...
	/**
	 * The summaries are performed for each measure to be displayed in the user
	 * interface
	 * 
	 * @return SummaryTable
	 */
	...
	/**
	 * Generates an HTML summary, in which the rows are the datasets and the columns
	 * the algorithms.
	 */
