...
public class PlotTab extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButtonInPath.addActionListener(
        ...
        jButtonDeletAlgorithm.addActionListener(
                new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jButtonDeleteStream.addActionListener(
                new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jButtonAcept.addActionListener(
                new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jComboBoxGrid.setModel(
                new javax.swing.DefaultComboBoxModel(new String[] {"White", "Default"}));
        ...
        jButtonAceptGnuP.addActionListener(
                new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jButtonResetGnuP.addActionListener(
                new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jScrollPaneGnuP.setHorizontalScrollBarPolicy(
                javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        ...
        jTextFieldGNUPath.addActionListener(
                new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jButtonGnuoPath.addActionListener(
                new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jComboBoxLegendLocation.setModel(
                new javax.swing.DefaultComboBoxModel(
                        new String[] {
        ...
        jComboBoxLegendLocation.addActionListener(
                new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
                                                ...
                                                jPanelGnuPLayout
                                                        ...
                                                        .addComponent(
                                                                ...
                                                                javax.swing.GroupLayout.Alignment
                                                                        .TRAILING)
                                                        .addComponent(
                                                                jTextFieldyTitleGnuP,
                                                                javax.swing.GroupLayout.Alignment
                                                                        .TRAILING)
                                                        .addComponent(
                                                                jTextFieldxTitleGnuP,
                                                                javax.swing.GroupLayout.Alignment
                                                                        .TRAILING)
                                                        .addComponent(
                                                                jComboBoxLineStyle,
                                                                ...
                                                                Short.MAX_VALUE)
                                                        .addComponent(
                                                                jComboBoxXColumnGnuP,
                                                                0,
                                                                javax.swing.GroupLayout
                                                                        .DEFAULT_SIZE,
                                                                Short.MAX_VALUE)
                                                        .addComponent(
                                                                jComboBoxYColumnGnuP,
                                                                0,
                                                                javax.swing.GroupLayout
                                                                        .DEFAULT_SIZE,
                                                                Short.MAX_VALUE)
                                                        .addComponent(
                                                                jComboBoxLegendLocation,
                                                                0,
                                                                542,
                                                                Short.MAX_VALUE)
                                                        .addGroup(
    ...
    private void jButtonInPathActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonInPathActionPerformed
    ...
    private void jButtonDeletAlgorithmActionPerformed(
            java.awt.event.ActionEvent
                    evt) { // GEN-FIRST:event_jButtonDeletAlgorithmActionPerformed
    ...
    private void jButtonDeleteStreamActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonDeleteStreamActionPerformed
    ...
    private void jButtonAceptActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonAceptActionPerformed
        ...
        for (int i = 0; i < streamCount; i++) {
            ...
            for (int j = 0; j < algCount; j++) {
                try {
                    ...
                    int x =
                            ReadFile.getMeasureIndex(
                                    algPath, this.jComboBoxXColumn.getSelectedItem().toString());
                    int y =
                            ReadFile.getMeasureIndex(
                                    algPath, this.jComboBoxYColumn.getSelectedItem().toString());
            ...
            this.chart[i] =
                    new ImageChart(
                            streamID,
                            imgChart,
                            (int) this.jSpinnerWidth.getValue(),
    ...
    private void jButtonAceptGnuPActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonAceptGnuPActionPerformed
        ...
        if (!this.jTextFieldResultPath.getText().equals("")) {
            ...
            if (!outPath.equals("")) {
                ...
                if (!gnuplotDir.exists()) {
                    JOptionPane.showMessageDialog(
                            this,
                            "Gnuplot directory not found: " + gnuPlotPath,
                            "Error",
                            JOptionPane.ERROR_MESSAGE);
                    return;
                }
                ...
                for (int i = 0; i < this.jTableStreams.getRowCount(); i++) {
                    ...
                    for (int j = 0; j < this.jTableAlgoritms.getRowCount(); j++) {
                        ...
                        algShortName[j] =
                                this.jTableAlgoritms.getModel().getValueAt(j, 1).toString();
                        File inputFile =
                                new File(
                                        FilenameUtils.separatorsToSystem(
                    ...
                    gnuplotScriptPath =
                            resultDirectory + File.separator + resultFile.getName() + ".plt";
                    ...
                    try {
                        ...
                        JOptionPane.showMessageDialog(
                                this,
                                "Error while executing gnuplot script",
                                "Error",
                                JOptionPane.ERROR_MESSAGE);
                        throw new RuntimeException(
                                "Error while executing gnuplot script:" + scriptFile, ex);
                    }
                ...
                JOptionPane.showMessageDialog(
                        this,
                        "Figures created at "
                                + (new File(resultFile.getAbsolutePath())).getParent(),
                        "",
                        JOptionPane.INFORMATION_MESSAGE);
            }
        } else {
            JOptionPane.showMessageDialog(
                    this, "Plot output file option not set!", "Error", JOptionPane.ERROR_MESSAGE);
        }
    } // GEN-LAST:event_jButtonAceptGnuPActionPerformed

    private void jButtonResetGnuPActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonResetGnuPActionPerformed
        resetP();
    } // GEN-LAST:event_jButtonResetGnuPActionPerformed

    private void jButtonGnuoPathActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonGnuoPathActionPerformed
    ...
    private void jComboBoxLegendLocationActionPerformed(
            java.awt.event.ActionEvent
                    evt) { // GEN-FIRST:event_jComboBoxLegendLocationActionPerformed
        // TODO add your handling code here:
    } // GEN-LAST:event_jComboBoxLegendLocationActionPerformed

    private void jTextFieldGNUPathActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jTextFieldGNUPathActionPerformed
        // TODO add your handling code here:
    ...
    private String getDirectory(String type, int filter) {
        ...
        int selection = -1;
        if (type.equals("open")) selection = gnuPlotDir.showOpenDialog(this);
    ...
    private String createScript(
            String streamName, String algName[], String algShortName[], String outPath) {
        ...
        script +=
                "set loadpath '"
                        + FilenameUtils.separatorsToSystem(path + File.separator + streamName)
                        + "'"
                        + newLine;
        ...
        if (!this.jComboBoxLegendType.getSelectedItem().toString().equals(LegendType.NONE)) {
            script +=
                    "set key "
                            + this.jComboBoxLegendType
                                    .getSelectedItem()
                                    .toString()
                                    .toLowerCase()
                                    .replace('_', ' ')
                            + " "
                            + this.jComboBoxLegendLocation
                                    .getSelectedItem()
                                    .toString()
                                    .toLowerCase()
                                    .replace('_', ' ')
        ...
        for (int i = 0; i < algName.length; i++) {
            ...
            script +=
                    "'"
                            + algName[i]
                            + "' using "
                            + (this.jComboBoxXColumnGnuP.getSelectedIndex() + 1)
                            + ":"
            ...
            script +=
                    " with "
                            + this.jComboBoxLineStyle.getSelectedItem().toString().toLowerCase()
                            + " ls "
                            + sourceFileIdx
                            + " lw "
                            + this.jSpinnerLineWidth.getValue().toString();
            if (this.jComboBoxLineStyle
                            .getSelectedItem()
                            .toString()
                            .equals(PlotStyle.LINESPOINTS.toString())
