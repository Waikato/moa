...
/**
 * In this class are compared online learning algorithms on multiple datasets by performing
...
public class AnalyzeTab extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButtonResults.addActionListener(
        ...
        jButtonDelAlgoritm.addActionListener(
                new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jButtonDelStream.addActionListener(
                new java.awt.event.ActionListener() {
                    public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        jComboBoxTest.setModel(
                new javax.swing.DefaultComboBoxModel(new String[] {"Holm", "Shaffer", "Nemenyi"}));
        ...
        jSpinnerPvalue.setModel(
                new javax.swing.SpinnerNumberModel(
                        Double.valueOf(0.05d), null, null, Double.valueOf(0.001d)));
    ...
    private void jButtonResultsActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonResultsActionPerformed
        ...
        if (!path.equals("")) {
            ...
            if (str.equals("")) {
                ...
                for (int i = 0; i < algSize; i++) {
                    this.algoritmModel.addRow(
                            new Object[] {rf.getAlgNames().get(i), rf.getAlgShortNames().get(i)});
                }
                for (int i = 0; i < streamSize; i++) {
                    this.streamModel.addRow(
                            new Object[] {rf.getStream().get(i), rf.getStream().get(i)});
                }
                ...
                for (String measuresName : measuresNames) {
                    ...
                    if (measuresName.equals("classifications correct (percent)") == true
                            || measuresName.equals("[avg] classifications correct (percent)")
                                    == true) {
    ...
    private void jButtonDelAlgoritmActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonDelAlgoritmActionPerformed
    ...
    private void jButtonDelStreamActionPerformed(
            java.awt.event.ActionEvent evt) { // GEN-FIRST:event_jButtonDelStreamActionPerformed
    ...
    private void jButtonTestActionPerformed(
        ...
        Measure m =
                new Measure(
                        this.jComboBoxMeasure.getSelectedItem().toString(),
                        this.jComboBoxMeasure.getSelectedItem().toString(),
                        type,
                        0);
        algmeasures.add(m);
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    this, "Problem with csv file", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        this.jTextAreaOut.append(
                "P-value computed by Friedman Test: " + test.getFriedmanPValue() + "\n");
        this.jTextAreaOut.append(
                "P-value computed by Iman and Daveport Test: " + test.getImanPValue() + "\n");
