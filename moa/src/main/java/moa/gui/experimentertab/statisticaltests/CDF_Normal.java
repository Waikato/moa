...
public class CDF_Normal extends Object {
	 ...
	 * formula for approximating QINV is taken from Abramowitz and Stegun, Handbook
	 * of Mathematical Functions, Dover, 9th printing, formula 26.2.3, page 933. The
	 * error in x is claimed to be less than 4.5e-4 in absolute value.
	 *
	 * @param p p must lie between 0 and 1. xnormi returns the normal cdf inverse
	 *          evaluated at p.
	 *
...
//  FIX: Eventually I should build in a check that p lies in (0,1)
	...
	*       Hart, J.F. et al, 'Computer Approximations', Wiley 1968
	 ...
	 *
	 * @param z The method returns the value of the normal cumulative distribution
	 *          function at z.
	 *
	 ...
	 * 
	 * SUBROUTINE NORMP(Z, P, Q, PDF) C C Normal distribution probabilities accurate
	 * to 1.e-15. C Z = no. of standard deviations from the mean. C P, Q =
	 * probabilities to the left & right of Z. P + Q = 1. C PDF = the probability
	 * density. C C Based upon algorithm 5666 for the error function, from: C Hart,
	 * J.F. et al, 'Computer Approximations', Wiley 1968 C C Programmer: Alan Miller
	 * C C Latest revision - 30 March 1986 C
	 * 
	 */
