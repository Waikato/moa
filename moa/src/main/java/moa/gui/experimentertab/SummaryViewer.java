...
public class SummaryViewer extends JFrame {
     ...
     */
    public SummaryViewer(SummaryTable[] summaryTable, Summary summary, String resultsPath)
            throws HeadlessException {
        ...
        tableSummary.setModel(
                new javax.swing.table.DefaultTableModel(
                        this.summaryTable[0].value, this.summaryTable[0].algNames));
    ...
    private void summaryTypeItemStateChanged(java.awt.event.ItemEvent evt) {
        for (SummaryTable summary1 : this.summaryTable) {
            if (summaryType.getSelectedItem().equals(summary1.measureName) == true) {
                tableSummary.setModel(
                        new javax.swing.table.DefaultTableModel(summary1.value, summary1.algNames));
                break;
            }
        }
    }
    ...
    private void btnExportActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (!path.equals("")) {
            ...
            JOptionPane.showMessageDialog(
                    this, "Summaries created at: " + path, "", JOptionPane.INFORMATION_MESSAGE);
        }
    }
}
