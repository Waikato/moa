...
public class SummaryTab extends JPanel {
	...
	private void initComponents() {
		...
		jTableMeasures.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {},
				new String[] { "Measure", "Measure ID", "Option" }));
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGroup(jPanel1Layout
						...
						.addGroup(jPanel1Layout.createSequentialGroup().addContainerGap()
								...
								.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jScrollPaneStreams, javax.swing.GroupLayout.DEFAULT_SIZE, 332,
												Short.MAX_VALUE)
		...
		jPanel1Layout.setVerticalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
						jPanel1Layout.createSequentialGroup().addGap(23, 23, 23)
								...
								.addGap(18, 18, 18)
								.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(jScrollPaneAlgorithms, javax.swing.GroupLayout.DEFAULT_SIZE, 305,
												Short.MAX_VALUE)
		...
		layout.setVerticalGroup(
				layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGap(0, 443, Short.MAX_VALUE)
						.addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(layout.createSequentialGroup().addContainerGap()
										.addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE,
												javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
	...
	private void jButtonAddMeasureActionPerformed(java.awt.event.ActionEvent evt) {
		...
		this.measureModel.addRow(
				new Object[] { jComboBoxMeasure.getSelectedItem(), jComboBoxMeasure.getSelectedItem(), "Mean" });
	...
	private void jButtonShowSummaryActionPerformed(java.awt.event.ActionEvent evt) {
		...
		for (int i = 0; i < this.measureModel.getRowCount(); i++) {
			for (int j = 0; j < this.jComboBoxMeasure.getItemCount(); j++) {
				...
				if (this.measureModel.getValueAt(i, 0).equals("") || this.measureModel.getValueAt(i, 1).equals("")
					...
					JOptionPane.showMessageDialog(this, "There are fields incompleted in Table", "Error",
		...
		for (int k = 0; k < this.measureModel.getRowCount(); k++) {
			...
			Measure m = new Measure(this.measureModel.getValueAt(k, 1).toString(),
					this.measureModel.getValueAt(k, 0).toString(), type, 0);
			algmeasures.add(m);
