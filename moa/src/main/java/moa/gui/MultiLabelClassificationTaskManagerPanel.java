...
public class MultiLabelClassificationTaskManagerPanel extends JPanel {
	...
	public MultiLabelClassificationTaskManagerPanel() {
		...
		this.configureTaskButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				String newTaskString = ClassOptionSelectionPanel.showSelectClassDialog(
						MultiLabelClassificationTaskManagerPanel.this, "Configure task",
						MultiLabelClassificatioMainTask.class, MultiLabelClassificationTaskManagerPanel.this.currentTask
								.getCLICreationString(MultiLabelClassificatioMainTask.class),
						null);
				setTaskString(newTaskString);
			}
		});
		...
		javax.swing.Timer updateListTimer = new javax.swing.Timer(MILLISECS_BETWEEN_REFRESH, new ActionListener() {
	...
	public void setTaskString(String cliString, boolean storePreference) {
		try {
			this.currentTask = (MultiLabelClassificatioMainTask) ClassOption.cliStringToObject(cliString,
					MultiLabelClassificatioMainTask.class, null);
			String taskText = this.currentTask.getCLICreationString(MultiLabelClassificatioMainTask.class);
