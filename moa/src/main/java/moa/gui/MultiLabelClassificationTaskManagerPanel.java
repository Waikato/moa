...
import moa.tasks.structuredoutput.multilabelclassification.EvaluatePrequential;
import moa.tasks.structuredoutput.multilabelclassification.MultiLabelClassificatioMainTask;
 ...
 * @author Richard Kirkby (rkirkby@cs.waikato.ac.nz)
 */
public class MultiLabelClassificationTaskManagerPanel extends JPanel {
    ...
    protected class TaskTableModel extends AbstractTableModel {
        ...
        public int getRowCount() {
            return MultiLabelClassificationTaskManagerPanel.this.taskList.size();
        }

        @Override
        public Object getValueAt(int row, int col) {
            TaskThread thread = MultiLabelClassificationTaskManagerPanel.this.taskList.get(row);
            switch (col) {
                case 0:
                    return ((OptionHandler) thread.getTask()).getCLICreationString(MultiLabelClassificatioMainTask.class);
                case 1:
    ...
    protected MultiLabelClassificatioMainTask currentTask = new EvaluatePrequential();//LearnModel();
    ...
    public MultiLabelClassificationTaskManagerPanel() {
        // Read current task preference
        prefs = Preferences.userRoot().node(this.getClass().getName());
        currentTask = new EvaluatePrequential();
        String taskText = this.currentTask.getCLICreationString(MultiLabelClassificatioMainTask.class);
        ...
        this.configureTaskButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                String newTaskString = ClassOptionSelectionPanel.showSelectClassDialog(MultiLabelClassificationTaskManagerPanel.this,
                        "Configure task", MultiLabelClassificatioMainTask.class,
                        MultiLabelClassificationTaskManagerPanel.this.currentTask.getCLICreationString(MultiLabelClassificatioMainTask.class),
                        null);
                setTaskString(newTaskString);
            }
        });
        this.runTaskButton.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                runTask((Task) MultiLabelClassificationTaskManagerPanel.this.currentTask.copy());
            }
        });
        ...
        javax.swing.Timer updateListTimer = new javax.swing.Timer(
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                MultiLabelClassificationTaskManagerPanel.this.taskTable.repaint();
            }
        });
    ...
    public void setTaskString(String cliString, boolean storePreference) {    
        try {
            this.currentTask = (MultiLabelClassificatioMainTask) ClassOption.cliStringToObject(
                    cliString, MultiLabelClassificatioMainTask.class, null);
            String taskText = this.currentTask.getCLICreationString(MultiLabelClassificatioMainTask.class);
    ...
    public void taskSelectionChanged() {
        ...
        if (selectedTasks.length == 1) {
            setTaskString(((OptionHandler) selectedTasks[0].getTask()).getCLICreationString(MultiLabelClassificatioMainTask.class));
    ...
    public void saveLogSelectedTasks() {
        ...
        TaskThread[] selectedTasks = getSelectedTasks();
        for (TaskThread thread : selectedTasks) {
            tasksLog += ((OptionHandler) thread.getTask()).getCLICreationString(MultiLabelClassificatioMainTask.class) + "\n";
        }
    ...
    private static void createAndShowGUI() {
        ...
        JPanel panel = new MultiLabelClassificationTaskManagerPanel();
