...
/**
 * ProcessGraphCanvas is an implementation of AbstractGraphCanvas, showing one or multiple curves
 * over a process.
 *
 * @author Tim Sabsch (tim.sabsch@ovgu.de)
 * @version $Revision: 1 $
...
public class ProcessGraphCanvas extends AbstractGraphCanvas {
    ...
    /**
     * Initialises a ProcessGraphCanvas by calling the super constructor with a ProcessGraphAxes as
     * instance of AbstractGraphAxes and GraphMultiCurve as instance of AbstractGraphPlot. Also sets
     * the min_processfrequency to initial value.
     */
     ...
     * @param processFrequencies information about the process frequencies of the curves
    ...
    public void setGraph(
        ...
        ((GraphMultiCurve) this.plotPanel)
                .setGraph(measures, measureStds, processFrequencies, colors);
        updateCanvas(false);
    }
                ...
                new Dimension(
                        (int)
                                Math.max(
                                        ...
                                        (int) (max_x_value * x_resolution) + X_OFFSET_LEFT),
                        getHeight()));
    }
}
