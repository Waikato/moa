...
//    private int min_processFrequency;
	 ...
	 */
	protected void setGraph(MeasureCollection[] measures, MeasureCollection[] measureStds, int[] processFrequencies,
			Color[] colors) {
//    	this.processFrequencies = processFrequencies;   
	...
	/**
	 * Sets the minimum process frequency, which may be used to stretch or compress
	 * curves. NOTE this is currently not implemented
	 * 
