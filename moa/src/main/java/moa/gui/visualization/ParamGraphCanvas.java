...
public class ParamGraphCanvas extends AbstractGraphCanvas {
	 ...
	 * ParamGraphAxes as instance of AbstractGraphAxes and GraphScatter as instance
	 * of AbstractGraphPlot.
	 */
	 ...
	 */
	public void setGraph(MeasureCollection[] measures, MeasureCollection[] measureStds, double[] variedParamValues,
			Color[] colors) {
