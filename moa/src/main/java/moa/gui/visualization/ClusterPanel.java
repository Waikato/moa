...
public class ClusterPanel extends JPanel {
    ...
    public void updateLocation() {
        ...
        if (cluster != null && center == null) getParent().remove(this);
        else {
            // size of the parent
            ...
            if (panel_size < MIN_SIZE) panel_size = MIN_SIZE;

            setSize(new Dimension(panel_size + 1, panel_size + 1));
            setLocation(
                    (int) (center[x_dim] * window_size - (panel_size / 2)),
    ...
    public boolean contains(int x, int y) {
        ...
        if (panel_size / 2 - 5 < dist && dist < panel_size / 2 + 5) return true;
        else return false;
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (cluster.getId() >= 0) g.drawString("C" + (int) cluster.getId(), c, c);
        ...
        if (direction != null) {
            ...
            g.drawLine(
                    c,
                    c,
                    c + (int) ((direction[0] / length) * panel_size),
