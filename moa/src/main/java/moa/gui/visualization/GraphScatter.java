...
public class GraphScatter extends AbstractGraphPlot {
	 ...
	 */
	public void setGraph(MeasureCollection[] measures, MeasureCollection[] stds, double[] variedParamValues,
			Color[] colors) {
	...
	private void scatter(Graphics g, int i) {
		...
		int x = (int) (((this.variedParamValues[i] - this.lower_x_value) / (this.upper_x_value - this.lower_x_value))
				* width);
