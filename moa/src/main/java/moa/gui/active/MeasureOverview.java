...
/**
 * MeasureOverview provides a graphical overview of the current and mean measure
 * values during the runtime of a task.
 *
 * This class is partially based on
...
public class MeasureOverview extends JPanel {
	...
	/**
	 * Updates the measure overview by assigning new measure collections and varied
	 * parameter properties. If no measures are currently to display, reset the
	 * display to hyphens. Otherwise display the last measured and mean values.
	...
	/**
	 * Updates the measure overview. If no measures are currently to display, reset
	 * the display to hyphens. Otherwise display the last measured and mean values.
	 */
	public void update() {
	...
	/**
	 * Updates the parameter combo box. If there is no varied parameter, empty and
	 * disable the box. Otherwise display the available parameters.
	 */
