 ...
 * TastTextViewerPanel, this class supports multiple curves, standard deviations and two additional
 * views, which display a varied parameter and the relative label acquisition rate (usually called
 * budget).
 *
 * @author Tim Sabsch (tim.sabsch@ovgu.de)
 * @version $Revision: 1 $
...
public class ALTaskTextViewerPanel extends JPanel {
    ...
    public ALTaskTextViewerPanel() {
        ...
        this.exportButton.addActionListener(
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (fileChooser.showSaveDialog(ALTaskTextViewerPanel.this)
                            ...
                            try {
                                ...
                                GUIUtils.showExceptionDialog(
                                        ALTaskTextViewerPanel.this.exportButton,
        ...
        // init the measure overview. the dummy ALMeasureCollection[] is needed to properly init the
        // measure names
        this.measureOverview =
                new MeasureOverview(
                        new ALMeasureCollection[] {new ALMeasureCollection()}, "", null);
        this.measureOverview.setMinimumSize(new Dimension(280, 118));
        this.measureOverview.setPreferredSize(new Dimension(290, 115));
        this.measureOverview.setActionListener(
                new ActionListener() {
        ...
        paramGraphCanvasLayout.setHorizontalGroup(
                paramGraphCanvasLayout
                        .createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGap(0, 515, Short.MAX_VALUE));
        paramGraphCanvasLayout.setVerticalGroup(
                paramGraphCanvasLayout
                        .createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGap(0, 128, Short.MAX_VALUE));
        ...
        budgetGraphCanvasLayout.setHorizontalGroup(
                budgetGraphCanvasLayout
                        .createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGap(0, 515, Short.MAX_VALUE));
        budgetGraphCanvasLayout.setVerticalGroup(
                budgetGraphCanvasLayout
                        .createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGap(0, 128, Short.MAX_VALUE));
    ...
    public void setErrorText(FailedTaskReport failedTaskReport) {
        ...
        final String failedTaskReportString =
                failedTaskReport == null
                        ? "Failed Task Report is null"
        ...
        for (int columnIdx = 0; columnIdx < columnModel.getColumnCount(); ++columnIdx) {
            ...
            Component comp =
                    renderer.getTableCellRendererComponent(
                            previewTable, column.getHeaderValue(), false, false, 0, columnIdx);
    ...
    public void setGraph(Preview preview, Color[] colors) {
        ...
        if (c == ALPartitionEvaluationTask.class || c == ALMultiParamTask.class) {
            ...
            if (c == ALPartitionEvaluationTask.class) {
                ...
                MeanPreviewCollection mpc =
                        new MeanPreviewCollection(
    ...
    /**
     * Parses a PreviewCollection and return the resulting ParsedPreview object. If the
     * PreviewCollection contains PreviewCollections again, it recursively adds their results. If it
    ...
    /**
     * ParsedPreview represents the parsing results of a preview, namely the process frequencies and
     * the measure collections.
     *
     * @author Tim Sabsch (tim.sabsch@ovgu.de)
     * @version $Revision: 1 $
     */
    private class ParsedPreview {
        ...
        public MeasureCollection[] getMeasureCollectionsArray() {
            return this.measureCollections.toArray(
                    new MeasureCollection[this.measureCollections.size()]);
        }
    }
