...
public class ALTaskManagerPanel extends JPanel {
    ...
    protected class TaskColorCodingCellRenderer extends DefaultTableCellRenderer
    ...
    public ALTaskManagerPanel() {
        ...
        this.taskTable.getColumnModel().getColumn(0).setCellRenderer(taskColorCodingRenderer);
        this.taskTable.getColumnModel().getColumn(2).setCellRenderer(centerRenderer);
        this.taskTable.getColumnModel().getColumn(3).setCellRenderer(centerRenderer);
        this.taskTable.getColumnModel().getColumn(5).setCellRenderer(new ProgressCellRenderer());
                    ...
                    public void actionPerformed(ActionEvent arg0) {
                        String newTaskString =
                                ClassOptionSelectionPanel.showSelectClassDialog(
                                        ALTaskManagerPanel.this,
                                        "Configure task",
                                        ALMainTask.class,
                                        ALTaskManagerPanel.this.currentTask.getCLICreationString(
                                                ALMainTask.class),
                                        null);
    ...
    public void setTaskString(String cliString, boolean storePreference) {
        try {
            this.currentTask =
                    (ALMainTask) ClassOption.cliStringToObject(cliString, ALMainTask.class, null);
            String taskText = this.currentTask.getCLICreationString(ALMainTask.class);
        ...
        if (selectedTasks.length == 1) {
            setTaskString(
                    ((OptionHandler) selectedTasks[0].getTask())
                            .getCLICreationString(ALMainTask.class));
    ...
    public void saveLogSelectedTasks() {
        ...
        for (ALTaskThread thread : selectedTasks) {
            tasksLog +=
                    ((OptionHandler) thread.getTask()).getCLICreationString(ALMainTask.class)
                            + "\n";
        }
