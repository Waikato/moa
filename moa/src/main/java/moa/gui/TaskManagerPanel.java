...
public class TaskManagerPanel extends JPanel {
    ...
    protected JComboBox<String> viewModeList =
            new JComboBox<>(
                    new String[] {
                        Capability.VIEW_LITE.toString(), Capability.VIEW_STANDARD.toString()
                    });
    ...
    public TaskManagerPanel() {
        ...
        this.viewModeList.setPrototypeDisplayValue(
                Capability.VIEW_EXPERIMENTAL.toString()
                        + "        "); // Require extra spacing to force enough width
                    ...
                    public void actionPerformed(ActionEvent arg0) {
                        ...
                        String newTaskString =
                                ClassOptionSelectionPanel.showSelectClassDialog(
                                        TaskManagerPanel.this,
                                        "Configure task",
                                        ClassificationMainTask.class,
                                        TaskManagerPanel.this.currentTask.getCLICreationString(
                                                ClassificationMainTask.class),
                                        null);
                        setTaskString(newTaskString);
        ...
        this.viewModeList.addActionListener(
                new ActionListener() {
    ...
    public void saveLogSelectedTasks() {
        ...
        for (TaskThread thread : selectedTasks) {
            tasksLog +=
                    ((OptionHandler) thread.getTask()).getCLICreationString(MainTask.class) + "\n";
        }
    ...
    private CapabilityRequirement forViewSelection() {
        return CapabilityRequirement.has(
                Capability.forShortName((String) this.viewModeList.getSelectedItem()));
    }
