...
public class TaskManagerPanel extends JPanel {
	...
	protected JComboBox<String> viewModeList = new JComboBox<>(
			new String[] { Capability.VIEW_LITE.toString(), Capability.VIEW_STANDARD.toString() });
	...
	public TaskManagerPanel() {
		...
		this.viewModeList.setPrototypeDisplayValue(Capability.VIEW_EXPERIMENTAL.toString() + "        "); // Require
																											// extra
																											// spacing
																											// to force
																											// enough
		...
		this.configureTaskButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				String newTaskString = ClassOptionSelectionPanel.showSelectClassDialog(TaskManagerPanel.this,
						...
						TaskManagerPanel.this.currentTask.getCLICreationString(ClassificationMainTask.class), null);
				setTaskString(newTaskString);
	...
	public void setTaskString(String cliString, boolean storePreference) {
		try {
			this.currentTask = (MainTask) ClassOption.cliStringToObject(cliString, ClassificationMainTask.class, null);
