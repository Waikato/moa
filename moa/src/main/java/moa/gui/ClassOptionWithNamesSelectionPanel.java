 ...
 *
 * <p>ClassOptionWithNames: Selection panel
 *
...
public class ClassOptionWithNamesSelectionPanel extends JPanel {
    ...
    public ClassOptionWithNamesSelectionPanel(
            Class<?> requiredType,
        ...
        if (initialObject != null) {
            ...
            try {
                Object chosen =
                        ((Class<?>)
                                        ClassOptionWithNamesSelectionPanel.this.classChoiceBox
                                                .getSelectedItem())
                                .newInstance();
                ...
                new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent arg0) {
                        try {
                            Object chosen =
                                    ((Class<?>)
                                                    ClassOptionWithNamesSelectionPanel.this
                                                            .classChoiceBox.getSelectedItem())
                                            .newInstance();
                            classChoiceChanged(chosen);
                        } catch (Exception ex) {
                            GUIUtils.showExceptionDialog(
    ...
    public static String showSelectClassDialog(
            ...
            String nullString,
            String[] classNames) {
        ClassOptionWithNamesSelectionPanel panel =
                new ClassOptionWithNamesSelectionPanel(
