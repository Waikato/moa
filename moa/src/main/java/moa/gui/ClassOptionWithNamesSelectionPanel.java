...
public class ClassOptionWithNamesSelectionPanel extends JPanel {
	...
	public ClassOptionWithNamesSelectionPanel(Class<?> requiredType, String initialCLIString, String nullString,
			String[] classNames) {
		...
		if (initialObject != null) {
			...
			try {
				Object chosen = ((Class<?>) ClassOptionWithNamesSelectionPanel.this.classChoiceBox.getSelectedItem())
						.newInstance();
		...
		this.classChoiceBox.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					Object chosen = ((Class<?>) ClassOptionWithNamesSelectionPanel.this.classChoiceBox
	...
	public static String showSelectClassDialog(Component parent, String title, Class<?> requiredType,
			String initialCLIString, String nullString, String[] classNames) {
		ClassOptionWithNamesSelectionPanel panel = new ClassOptionWithNamesSelectionPanel(requiredType,
				initialCLIString, nullString, classNames);
		if (JOptionPane.showOptionDialog(parent, panel, title, JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE,
	...
	public void classChoiceChanged(Object chosen) {
		...
		if (this.chosenObject instanceof OptionHandler) {
			...
			newChosenObjectEditor = new OptionsConfigurationPanel(chosenOptionHandler.getPurposeString(),
					chosenOptionHandler.getOptions());
		}
