...
public class PreviewPanel extends JPanel implements ResultPreviewListener {
	...
	protected JComboBox<String> autoRefreshComboBox = new JComboBox<>(autoFreqStrings);
	...
	/**
	 * Requests the latest preview and sends it to the TextViewerPanel to display
	 * it.
	 */
