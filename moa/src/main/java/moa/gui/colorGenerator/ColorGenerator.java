...
/**
 * This interface specifies the generateColors method for classes which generate colors according
 * different strategies such that those colors can be distinguished easily.
 *
