 ...
 * different classes and attributes. Example: real datasets. <br/>
 * <br/>
 * Example: <br/>
 * <br/>
 ...
 * @version $Revision: 7 $
 */
public class ConceptDriftRealStream extends AbstractOptionHandler implements InstanceStream, CapabilitiesHandler {
	...
	public void prepareForUseImpl(TaskMonitor monitor, ObjectRepository repository) {
		...
		this.streamHeader = new InstancesHeader(
				new InstancesHeader(getCLICreationString(InstanceStream.class), newAttributes, 0));
