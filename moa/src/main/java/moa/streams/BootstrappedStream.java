 ...
 * @author Joao Duarte
 * @version $Revision: 1$*
 *     <p>Bootstraps a data stream using the poisson distribution
 */
public class BootstrappedStream extends AbstractOptionHandler
        implements InstanceStream, MultiTargetInstanceStream {
    ...
    public IntOption randomSeedOption =
            new IntOption("randomSeed", 'r', "Seed for the random generator", 1);
    ...
    public InstancesHeader getHeader() {
        ...
        if (originalStream != null) h = originalStream.getHeader();
        return h;
    }

    @Override
    public long estimatedRemainingInstances() {
        if (originalStream != null) return originalStream.estimatedRemainingInstances();
        else return 0;
    }
