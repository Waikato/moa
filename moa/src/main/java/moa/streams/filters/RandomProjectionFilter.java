...
/**
 * Filter to perform random projection to reduce the number of attributes. It applies a Gaussian
 * matrix on features to project them into a lower-dimensional space.
 *
 * @author Maroua Bahri
 */
public class RandomProjectionFilter extends AbstractStreamFilter {
    ...
    public IntOption dim =
            new IntOption("OutputFeatureDimension", 'd', "the target feature dimension.", 10);
    ...
    public InstanceExample nextInstance() {
        ...
        return new InstanceExample(
                transformedInstance(
                        sparseInstance, randomProjection(sparseInstance, this.GaussMatrix)));
    }
