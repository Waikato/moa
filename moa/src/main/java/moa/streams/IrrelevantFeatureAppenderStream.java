 ...
 *
 * <p>This is a meta-generator that appends irrelevant features in a stream. The following
 * parameters are required to be set: - The original stream, - The number of numeric features to be
 * appended, - The number of categorical features to be appended, and - The number of values for
 * each categorical feature.
 *
 * <p>The values for each new feature are drawn from an uniform distribution and are not related
 * with the class anyhow. This means that no correlation between each feature and the class will be
 * observed, and the entropy will be maximum.
 *
 * @author Jean Paul Barddal (jean.barddal@ppgia.pucpr.br)
 * @version 1.0
 */
public class IrrelevantFeatureAppenderStream extends AbstractOptionHandler
    ...
    public IntOption numNumericFeaturesOption =
            new IntOption(
                    "numNumericFeatures",
                    'n',
                    "Number of numeric features to be appended.",
                    0,
                    0,
                    1000);
    ...
    public IntOption numCategoricalFeaturesOption =
            new IntOption(
                    ...
                    'c',
                    "Number of categorical features to be appended.",
                    0,
                    0,
                    1000);
    ...
    public IntOption numValuesCategoricalFeatureOption =
            new IntOption(
                    "numValuesCategoricalFeature",
                    'v',
                    "Number of values for each categorical feature.",
                    2,
                    1,
                    1000);
    ...
    /**
     * Constructs the new header according to: 1- The original header 2- The number of numeric and
     * categorical features given by the user.
     */
