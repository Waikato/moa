 ...
 * @version $Revision: 7 $
 */
public class RandomRBFGenerator extends AbstractOptionHandler implements InstanceStream, CapabilitiesHandler {
	...
	public IntOption modelRandomSeedOption = new IntOption("modelRandomSeed", 'r',
	...
	public IntOption numCentroidsOption = new IntOption("numCentroids", 'n', "The number of centroids in the model.",
