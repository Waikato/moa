...
public class MixedGenerator extends AbstractOptionHandler implements InstanceStream {
	...
	public IntOption functionOption = new IntOption("function", 'f',
			"Classification function used, as defined in the original paper.", 1, 1, 2);
	...
	protected interface ClassFunction {
		...
		int determineClass(double v, double w, double x, double y);
	}

	protected static ClassFunction[] classificationFunctions = { new ClassFunction() {
		@Override
