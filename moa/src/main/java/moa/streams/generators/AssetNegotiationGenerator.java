 ...
 *      Gomes, F. Enembreck, B. Pfahringer & A. Bifet. ON DYNAMIC FEATURE
 *      WEIGHTING FOR FEATURE DRIFTING DATA STREAMS. In European Conference on
...
public class AssetNegotiationGenerator extends AbstractOptionHandler implements InstanceStream {
	...
	public IntOption functionOption = new IntOption("function", 'f',
			"Classification function used, as defined in the original paper.", 1, 1, 5);
	 ...
	 * FEATURE DEFINITIONS
	 */
	protected static String colorValues[] = { "black", "blue", "cyan", "brown", "red", "green", "yellow", "magenta" };

	protected static String priceValues[] = { "veryLow", "low", "normal", "high", "veryHigh", "quiteHigh", "enormous",
			"non_salable" };

	protected static String paymentValues[] = { "0", "30", "60", "90", "120", "150", "180", "210", "240" };

	protected static String amountValues[] = { "veryLow", "low", "normal", "high", "veryHigh", "quiteHigh", "enormous",
			"non_ensured" };

	protected static String deliveryDelayValues[] = { "veryLow", "low", "normal", "high", "veryHigh" };
	...
	protected interface ClassFunction {
		...
		int determineClass(String color, String price, String payment, String amount, String deliveryDelay);

		Instance makeTrue(Instance intnc);
	}

	protected static ClassFunction concepts[] = { new ClassFunction() {
		...
		public int determineClass(String color, String price, String payment, String amount, String deliveryDelay) {
			if ((price.equals("normal") && amount.equals("high")
					|| (color.equals("brown") && price.equals("veryLow") && deliveryDelay.equals("high")))) {
		...
		@Override
		public int determineClass(String color, String price, String payment, String amount, String deliveryDelay) {
			if ((price.equals("veryLow") && payment.equals("0") && amount.equals("high"))
					|| (color.equals("red") && price.equals("low") && payment.equals("30"))) {
				return indexOfValue("interested", classValues);
			}
			return indexOfValue("notInterested", classValues);
		}
		...
		@Override
		public int determineClass(String color, String price, String payment, String amount, String deliveryDelay) {
			if ((color.equals("black") && payment.equals("90") && deliveryDelay.equals("veryLow"))
					|| (color.equals("magenta") && price.equals("high") && deliveryDelay.equals("veryLow"))) {
				return indexOfValue("interested", classValues);
			}
			return indexOfValue("notInterested", classValues);
		}
		...
		@Override
		public int determineClass(String color, String price, String payment, String amount, String deliveryDelay) {
			if ((color.equals("blue") && payment.equals("60") && amount.equals("low") && deliveryDelay.equals("normal"))
					|| (color.equals("cyan") && amount.equals("low") && deliveryDelay.equals("normal"))) {
				return indexOfValue("interested", classValues);
			}
			return indexOfValue("notInterested", classValues);
		}
	...
	public void getDescription(StringBuilder sb, int indent) {
		sb.append("Generates instances based on 5 different concept functions "
				+ "that describe whether another agent is " + "interested or not in an item.");
	}
