 ...
 * @version 1.0 Originally discussed in F. Enembreck, B. C. Ávila, E. E. Scalabrin {@literal &} J-P.
 *     Barthès. LEARNING DRIFTING NEGOTIATIONS. In Applied Artificial Intelligence: An International
 *     Journal. Volume 21, Issue 9, 2007. DOI: 10.1080/08839510701526954 First used in the data
 *     stream configuration in J. P. Barddal, H. M. Gomes, F. Enembreck, B. Pfahringer {@literal &}
 *     A. Bifet. ON DYNAMIC FEATURE WEIGHTING FOR FEATURE DRIFTING DATA STREAMS. In European
...
public class AssetNegotiationGenerator extends AbstractOptionHandler implements InstanceStream {
    ...
    public FloatOption noisePercentage =
            new FloatOption("noise", 'n', "% of class noise.", 0.05, 0.0, 1.0f);
    ...
    protected static String priceValues[] = {
        "veryLow", "low", "normal", "high", "veryHigh", "quiteHigh", "enormous", "non_salable"
    };
    ...
    protected static String amountValues[] = {
        "veryLow", "low", "normal", "high", "veryHigh", "quiteHigh", "enormous", "non_ensured"
    };
    ...
    protected interface ClassFunction {
        ...
        public int determineClass(
                String color, String price, String payment, String amount, String deliveryDelay);
    ...
    public void getDescription(StringBuilder sb, int indent) {
        sb.append(
                "Generates instances based on 5 different concept functions "
