...
/**
 * Stream generator for SEA concepts functions. Generator described in the
 * paper:<br/>
 * W. Nick Street and YongSeog Kim "A streaming ensemble algorithm (SEA) for
 * large-scale classification", KDD '01: Proceedings of the seventh ACM SIGKDD
 * international conference on Knowledge discovery and data mining 377-382
 * 2001.<br/>
 * <br/>
 *
 * Notes:<br/>
...
public class SEAGenerator extends AbstractOptionHandler implements InstanceStream, CapabilitiesHandler {
	...
	public IntOption noisePercentageOption = new IntOption("noisePercentage", 'p',
			"Percentage of noise to add to the data.", 10, 0, 100);

	protected interface ClassFunction {

		int determineClass(double attrib1, double attrib2, double attrib3);
	}
