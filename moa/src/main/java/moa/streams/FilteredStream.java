 ...
 * @version $Revision: 7 $
 */
public class FilteredStream extends AbstractOptionHandler implements ExampleStream {
	...
	public ClassOption streamOption = new ClassOption("stream", 's', "Stream to filter.", ExampleStream.class,
			"generators.RandomTreeGenerator");

	public ClassOption filtersOption = new ClassOption("filters", 'f', "Filters to apply.", StreamFilter.class,
			"AddNoiseFilter");
