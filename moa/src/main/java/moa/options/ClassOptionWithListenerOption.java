...
public class ClassOptionWithListenerOption extends ClassOption {
	...
	public ClassOptionWithListenerOption(String name, char cliChar, String purpose, Class<?> requiredType,
	...
	public ClassOptionWithListenerOption(String name, char cliChar, String purpose, Class<?> requiredType,
			String defaultCLIString, String nullString, ChangeListener listener) {
		super(name, cliChar, purpose, requiredType, defaultCLIString, nullString);
		this.listener = listener;
	}
