...
public class OptionsHandler extends JavaCLIParser {
    ...
    /**
     * This method describes the implementation of how to prepare this object for use. All classes
     * that extends this class have to implement <code>prepareForUseImpl</code> and not <code>
     * prepareForUse</code> since <code>prepareForUse</code> calls <code>prepareForUseImpl</code>.
     *
        ...
        for (Option option : optionArray) {
            if (option instanceof ClassOption) {
                ...
                monitor.setCurrentActivity(
                        "Materializing option " + classOption.getName() + "...", -1.0);
                ...
                if (optionObj instanceof OptionHandler) {
                    monitor.setCurrentActivity(
                            "Preparing option " + classOption.getName() + "...", -1.0);
