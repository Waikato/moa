...
public class ClassOptionWithNames extends AbstractClassOption {
	...
	public ClassOptionWithNames(String name, char cliChar, String purpose, Class<?> requiredType,
			String defaultCLIString, String[] classNames) {
		super(name, cliChar, purpose, requiredType, defaultCLIString);
		this.names = classNames;
	}

	public ClassOptionWithNames(String name, char cliChar, String purpose, Class<?> requiredType,
			String defaultCLIString, String nullString, String[] classNames) {
	...
	public static Object cliStringToObject(String cliString, Class<?> requiredType, Option[] externalOptions)
			throws Exception {
		...
		if (requiredType.isInstance(classInstance) || ((classInstance instanceof Task)
