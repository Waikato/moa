...
public class DataObject {
	...
	/**
	 * Returns a <code>String</code> representation of the point. The features are
	 * written comma separated between parenthesis and the label id is written after
	 * the closing parenthesis surrounded by squared brackets.
	 * 
