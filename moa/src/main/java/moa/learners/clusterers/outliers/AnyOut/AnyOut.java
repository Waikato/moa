...
public class AnyOut extends MyBaseOutlierDetector {
	...
	public String getObjectInfo(Object o) {
		...
		sb.append("<tr><td><b>X, Y:</b></td><td>" + String.format("%.4f", features[0]) + ", "
				+ String.format("%.4f", features[1]) + "</td></tr>");
	...
	public String getStatistics() {
		...
		sb.append(String.format("  True positive found: %d (%.1f%%)\n", truePositive,
				(100 * truePositive) / (double) totalOutliers));
		sb.append(String.format("  False positive found: %d (%.1f%%)\n", falsePositive,
				(100 * falsePositive) / (double) totalOutliers));
		sb.append("\n");
