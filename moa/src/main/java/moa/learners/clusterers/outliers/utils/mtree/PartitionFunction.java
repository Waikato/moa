...
public interface PartitionFunction<DATA> {
	 ...
	 * @param distanceFunction A {@linkplain DistanceFunction distance function} to
	 *                         be used on the partitioning.
	 * @return A pair of partition sub-sets. Each sub-set must correspond to one of
	 *         the {@code promoted} data objects.
	 */
