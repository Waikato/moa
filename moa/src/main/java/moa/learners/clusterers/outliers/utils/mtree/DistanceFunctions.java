...
public final class DistanceFunctions {
	 ...
	 * function}. This method is used internally by {@link MTree} to create a cached
	 * distance function to pass to the {@linkplain SplitFunction split function}.
	 * 
	 ...
	 * 
	 * @see <a href="http://en.wikipedia.org/wiki/Euclidean_space">"Euclidean Space"
	...
	public interface EuclideanCoordinate {
		 ...
		 *
		 * @param index The index of the component. Must be less than
		 *              {@link #dimensions()}.
		 */
	...
	/**
	 * Calculates the distance between two {@linkplain EuclideanCoordinate euclidean
	 * coordinates}.
	 */
	...
	/**
	 * A {@linkplain DistanceFunction distance function} object that calculates the
	 * distance between two {@linkplain EuclideanCoordinate euclidean coordinates}.
	 */
	...
	/**
	 * A {@linkplain DistanceFunction distance function} object that calculates the
	 * distance between two coordinates represented by {@linkplain java.util.List
	 * lists} of {@link java.lang.Integer}s.
	 */
	 ...
	 * A {@linkplain DistanceFunction distance function} object that calculates the
	 * distance between two coordinates represented by {@linkplain java.util.List
	 * lists} of {@link java.lang.Double}s.
	 */
