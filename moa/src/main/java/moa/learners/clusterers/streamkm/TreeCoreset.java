...
public class TreeCoreset {
	...
	protected class treeNode {
		...
		/**
		 * initalizes root as a treenode with the union of setA and setB as pointset and
		 * centre as centre
		 **/
		...
		/**
		 * Computes the target function value of the n points of the treenode. Differs
		 * from the function "targetFunctionValue" in three things:
		 * 
	...
	/**
	 * splits the parent node and creates two child nodes (one with the old centre
	 * and one with the new one)
	 **/
	void split(treeNode parent, Point newCentre, int newCentreIndex) {
		...
		// 1. Counts how many points belong to the new and how many points belong to the
		// old centre
		int nOld = 0;
		int nNew = 0;
