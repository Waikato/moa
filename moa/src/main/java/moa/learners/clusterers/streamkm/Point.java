...
public class Point {
	...
	/**
	 * Computes the cost of this point with the given array of centres centres[] (of
	 * size k)
	 **/
	...
	/**
	 * Computes the index of the centre nearest to this point with the given array
	 * of centres centres[] (of size k)
	 **/
