...
public class ClusteringFeature extends SphereCluster {
	 ...
	 * @param sumPoints        the sum of all points
	 * @param sumSquaredPoints the sum of the squared lengths
	 * @param radius           the radius
	 */
	public ClusteringFeature(double[] center, int numPoints, double[] sumPoints, double sumSquaredPoints,
			double radius) {
	 ...
	 * @param sumPoints        the sum of points to add
	 * @param sumSquaredPoints the sum of the squared lengths to add
	 */
	 ...
	 *
	 * @param x the ClusteringFeature to merge with
	 */
	 ...
	 *
	 * @param numPoints the number of points of the ClusteringFeature to set
	 */
	 ...
	 *
	 * @param sumPoints the sum of points of the ClusteringFeature to set
	 */
	 ...
	 *
	 * @param sumSquaredLength the sum of the squared lengths of the
	 *                         ClusteringFeature to set
	 */
	 ...
	 *
	 * @param threshold the threshold of the ClusteringFeature to set
	 */
	...
	public double calcKMeansCosts(double[] center) {
		...
		return this.sumSquaredLength - 2 * Metric.dotProduct(this.sumPoints, center)
