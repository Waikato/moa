...
public class Metric {
	...
	/**
	 * Calculates the Euclidean distance of the first point divided by a first
	 * scalar and another second point divided by a second scalar.
	 *
	 * @param pointA first point
	 * @param dA     first scalar
	 * @param pointB second point
	...
	/**
	 * Calculates the dot product of the addition of the first and the second point
	...
	/**
	 * Calculates the dot product of the addition of the first and the second point
	 * with the addition of the third and the fourth point.
	 *
	 * @param pointA1 first point
	 * @param pointA2 second point
	 ...
	 * @return the dot product
	 */
	public static double dotProductWithAddition(double[] pointA1, double[] pointA2, double[] pointB1,
			double[] pointB2) {
		assert (pointA1.length == pointA2.length && pointB1.length == pointB2.length
