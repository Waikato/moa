...
package moa.learners.clusterers.clustream;
...
public class WithKmeans extends AbstractClusterer {
	...
	public IntOption maxNumKernelsOption = new IntOption("maxNumKernels", 'm',
			"Maximum number of micro kernels to use.", 100);

	public IntOption kernelRadiFactorOption = new IntOption("kernelRadiFactor", 't', "Multiplier for the kernel radius",
			2);
