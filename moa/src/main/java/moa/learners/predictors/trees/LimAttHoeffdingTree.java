 ...
 * decision trees. For more information see,<br/>
 * <br/>
 ...
 * 225-240 (2010) * <!-- technical-bibtex-start --> BibTeX:
 * 
 * <pre>
 * &#64;article{BifetFHP10,
...
public class LimAttHoeffdingTree extends HoeffdingTree {
	...
	public static class LearningNodeNBAdaptive extends LearningNodeNB {
		...
		public double[] getClassVotes(Instance inst, HoeffdingTree ht) {
			...
			double ret[] = NaiveBayes.doNaiveBayesPrediction(inst, this.observedClassDistribution,
