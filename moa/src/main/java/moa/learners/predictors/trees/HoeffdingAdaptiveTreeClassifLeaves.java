...
public class HoeffdingAdaptiveTreeClassifLeaves extends HoeffdingAdaptiveTree {
	...
	public ClassOption leaveLearnerOption = new ClassOption("leaveLearner", 'a', "Classifier to train.",
				...
				if (splitDecision.splitTest == null) {
					...
					for (int i = 0; i < splitDecision.numSplits(); i++) {
						...
						Node newChild = newLearningNode(splitDecision.resultingClassDistributionFromSplit(i),
								((LearningNodeHATClassifier) node).getClassifier());
	...
	public class LearningNodeHATClassifier extends AdaLearningNode {
		...
		public LearningNodeHATClassifier(double[] initialClassObservations, Classifier cl,
