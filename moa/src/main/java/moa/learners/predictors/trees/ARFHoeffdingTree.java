 ...
 *
 * <p>
 * Adaptive Random Forest Hoeffding Tree. This is the base model for the
 * Adaptive Random Forest ensemble learner (See
 * moa.learners.predictors.meta.AdaptiveRandomForest.java). This Hoeffding Tree includes
 * a subspace size k parameter, which defines the number of randomly selected
 * features to be considered at each split.
 * </p>
 *
 * <p>
 * See details in:<br>
