 ...
 *
 * <p>
 * Performs classic bayesian prediction while making naive assumption that all
 * inputs are independent.<br />
 ...
 * classiﬁer predicts for every unlabelled instance I the class C to which it
...
public class NaiveBayes extends AbstractClassifier implements Classifier, CapabilitiesHandler {
	...
	public Prediction getPredictionForInstance(Instance inst) {
		return new ClassificationPrediction(
				doNaiveBayesPrediction(inst, this.observedClassDistribution, this.attributeObservers));
	}
