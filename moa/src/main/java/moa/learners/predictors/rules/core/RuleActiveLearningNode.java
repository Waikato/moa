 ...
 *
 */
package moa.learners.predictors.rules.core;
...
import moa.learners.predictors.rules.driftdetection.PageHinkleyFading;
import moa.learners.predictors.rules.driftdetection.PageHinkleyTest;
import moa.learners.predictors.trees.HoeffdingTree;
import moa.learners.predictors.trees.HoeffdingTree.ActiveLearningNode;
...
public abstract class RuleActiveLearningNode extends ActiveLearningNode {
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#learnFromInstance(weka.
	 * core.Instance)
	 */
	 ...
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#learnFromInstance(weka.
	 * core.Instance, moa.learners.predictors.trees.HoeffdingTree)
	 */
	@Override
	...
	protected AttributeClassObserver newNumericClassObserver() {
		...
		return (AttributeClassObserver) ((AttributeClassObserver) this.amRules.numericObserverOption
				.getPreMaterializedObject()).copy();
	}
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#updateStatistics(weka.
	 * core.Instance)
	 */
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#getAttributeObservers()
	 */
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#getPrediction(weka.core
	 * .Instance)
	 */
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#getNormalizedPrediction
	 * (weka.core.Instance)
	 */
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#computeError(weka.core.
	 * Instance)
	 */
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#updatePageHinckleyTest(
	 * double)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see moa.learners.predictors.rules.RuleActiveLearningNodeInterface#getInstancesSeen()
	 */
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#isAnomaly(weka.core.
	 * Instance, double, double, int)
	 */
	abstract public boolean isAnomaly(Instance instance, double uniVariateAnomalyProbabilityThreshold,
			double multiVariateAnomalyProbabilityThreshold, int numberOfInstanceesForAnomaly);
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#computeProbability(
	...
	public double computeProbability(double mean, double sd, double value) {
		...
		/*
		 * double diff = value - mean; if (sd > 0.0) { double k = (Math.abs(value -
		 * mean) / sd); if (k > 1.0) { probability = 1.0 / (k * k); // Chebyshev's
		 * inequality } else { probability = Math.exp(-(diff * diff / (2.0 * sd * sd)));
		 * } }
		 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see moa.learners.predictors.rules.RuleActiveLearningNodeInterface#getSplitIndex()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see moa.learners.predictors.rules.RuleActiveLearningNodeInterface#setSplitIndex(int)
	 */
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#getBestSuggestion()
	 */
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#setBestSuggestion(moa.
	 * classifiers.core.AttributeSplitSuggestion)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see moa.learners.predictors.rules.RuleActiveLearningNodeInterface#
	 ...
	 * 
	 * @see moa.learners.predictors.rules.RuleActiveLearningNodeInterface#
	 * setStatisticsBranchSplit(double[])
	 */
	 ...
	 * 
	 * @see moa.learners.predictors.rules.RuleActiveLearningNodeInterface#
	 * setStatisticsNewRuleActiveLearningNode(double[])
	 */
	 ...
	 * 
	 * @see moa.learners.predictors.rules.RuleActiveLearningNodeInterface#
	 * setStatisticsOtherBranchSplit(double[])
	 */
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#tryToExpand(double,
	 * double)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see moa.learners.predictors.rules.RuleActiveLearningNodeInterface#initialize(moa.
	 * classifiers.rules.RuleActiveLearningNode)
	 */
	 ...
	 * 
	 * @see
	 * moa.learners.predictors.rules.RuleActiveLearningNodeInterface#getSimplePrediction()
	 */
