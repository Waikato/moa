...
import moa.learners.predictors.rules.AMRulesMultiLabelLearner;
import moa.learners.predictors.rules.MultiLabelRandomAMRules;
...
public class RandomAMRules extends MultiLabelRandomAMRules implements MultiTargetRegressor {
	...
	public RandomAMRules() {
		super();
		baseLearnerOption = new ClassOption("baseLearner", 'l', "Classifier to train.", AMRulesMultiLabelLearner.class,
