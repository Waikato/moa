...
/**
 * Returns the probability for anomaly detection according to a Chebyshev
 * inequality mean- mean of a data variable sd- standard deviation of a data
 * variable value- current value of the variable
 */
