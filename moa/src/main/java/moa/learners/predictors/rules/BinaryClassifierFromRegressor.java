...
public class BinaryClassifierFromRegressor extends AbstractClassifier {
	 ...
	 *
	 */
	public ClassOption baseLearnerOption = new ClassOption("baseLearner", 'r', "Regressor to train.", Regressor.class,
	...
	public Prediction getPredictionForInstance(Instance inst) {
		...
		// Current function is the step function. By default should return regressor
		// values
		double vote = this.regressor.getPredictionForInstance(inst).asDouble(); // Maybe pass the value through a
																				// sigmoid function
