...
import moa.learners.predictors.core.attributeclassobservers.SingleVector;

/**
 * Class that contains several utilities Variance Standard deviation Vector
 * operations(copy, etc) Entropy Complementary set
 */
