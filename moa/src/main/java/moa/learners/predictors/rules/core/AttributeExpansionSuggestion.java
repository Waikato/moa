 ...
 * @version $Revision: 1 $
 */
public class AttributeExpansionSuggestion extends AbstractMOAObject
		implements Comparable<AttributeExpansionSuggestion> {
	...
	public int compareTo(AttributeExpansionSuggestion comp) {
		if (Double.isNaN(this.merit) && Double.isNaN(comp.merit))
			return 0;
		if (Double.isNaN(this.merit))
			return -1;
		if (Double.isNaN(comp.merit))
			return 1;
