 ...
 * various linear models (binary class SVM, binary class logistic regression and
 * linear regression).
 * <p/>
 * <!-- globalinfo-end -->
 *
 */
public class SGDMultiClass extends AbstractClassifier implements Classifier, Regressor {
