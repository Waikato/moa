...
import moa.learners.predictors.AbstractInstanceLearner;
 ...
 * Eighth IEEE International Conference on Data Mining (ICDM), 2008, pp.23-32
 * </p>
 *
...
public class PairedLearners extends AbstractClassifier implements Classifier {
	...
	public ClassOption stableLearnerOption = new ClassOption("stableLearner", 's', "Stable learner", Classifier.class,
			"bayes.NaiveBayes");

	public ClassOption reactiveLearnerOption = new ClassOption("reactiveLearner", 'r', "Reactive learner",
			Classifier.class, "bayes.NaiveBayes");

	public IntOption windowSizeOption = new IntOption("windowSize", 'w', "Window size for the reactive learner", 12, 1,
			Integer.MAX_VALUE);

	public FloatOption thresholdOption = new FloatOption("threshold", 't',
			"Threashold for creating a new stable learner", 0.2, 0, 1);
