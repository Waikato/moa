...
public class RandomRules extends AbstractRegressor implements Regressor {
	...
	public ClassOption baseLearnerOption = new ClassOption("baseLearner", 'l', "Regressor to train.", Regressor.class,
	...
	protected Instance transformInstance(Instance inst, int classifierIndex) {
		if (this.listAttributes == null) {
			...
			// inst.numAttributes()/100.0); // JD: number of attributes should not consider
			// class
			this.numAttributes = (int) (this.numAttributesPercentageOption.getValue() * (inst.numAttributes() - 1)
					/ 100.0);
