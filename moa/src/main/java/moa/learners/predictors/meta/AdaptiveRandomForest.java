...
import moa.learners.predictors.trees.ARFHoeffdingTree;
...
public class AdaptiveRandomForest extends AbstractClassifier implements Classifier, CapabilitiesHandler {
	...
	public ClassOption treeLearnerOption = new ClassOption("treeLearner", 'l', "Random Forest Tree.",
			ARFHoeffdingTree.class, "ARFHoeffdingTree -e 2000000 -g 50 -c 0.01");
	...
	public static final int FEATURES_M = 0;
	public static final int FEATURES_SQRT = 1;
	public static final int FEATURES_SQRT_INV = 2;
	public static final int FEATURES_PERCENT = 3;
...
//        BasicClassificationPerformanceEvaluator classificationEvaluator = (BasicClassificationPerformanceEvaluator) getPreparedClassOption(this.evaluatorOption);
		...
		for (int i = 0; i < ensembleSize; ++i) {
			...
			this.ensemble[i] = new ARFBaseLearner(i, (ARFHoeffdingTree) treeLearner.copy(),
	...
	protected final class ARFBaseLearner extends AbstractMOAObject {
		...
		public ARFBaseLearner(int indexOriginal, ARFHoeffdingTree instantiatedClassifier,
				BasicClassificationPerformanceEvaluator evaluatorInstantiated, long instancesSeen,
				boolean useBkgLearner, boolean useDriftDetector, ClassOption driftOption, ClassOption warningOption,
				boolean isBackgroundLearner) {
