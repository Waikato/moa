 ...
 * <p>
 * See details in:<br />
 * Albert Bifet, Geoffrey Holmes, Bernhard Pfahringer. Leveraging Bagging for
 * Evolving Data Streams Machine Learning and Knowledge Discovery in Databases,
 ...
 * @version $Revision: 7 $
 */
public class LeveragingBag extends AbstractClassifier implements Classifier, CapabilitiesHandler {
	...
	public MultiChoiceOption leveraginBagAlgorithmOption = new MultiChoiceOption("leveraginBagAlgorithm", 'm',
			"Leveraging Bagging to use.",
			new String[] { "LeveragingBag", "LeveragingBagME", "LeveragingBagHalf", "LeveragingBagWT",
					"LeveragingSubag" },
