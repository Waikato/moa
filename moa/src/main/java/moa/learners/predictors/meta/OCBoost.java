 ...
 *
 * <p>
 * Pelossof et al. presented Online Coordinate Boosting, a new online boosting
 * algorithm for adapting the weights of a boosted classiﬁer, which yields a
 * closer approximation to Freund and Schapire’s AdaBoost algorithm. The weight
 * update procedure is derived by minimizing AdaBoost’s loss when viewed in an
 * incremental form. This boosting method may be reduced to a form similar to
 * Oza and Russell’s algorithm.
 * </p>
 *
 * <p>
 * See details in:<br />
 * Raphael Pelossof, Michael Jones, Ilia Vovsha, and Cynthia Rudin. Online
 * coordinate boosting. 2008.
 * </p>
 * <p>
 * Example:
 * </p>
...
public class OCBoost extends AbstractClassifier implements Classifier {
	...
	public FloatOption smoothingOption = new FloatOption("smoothingParameter", 'e', "Smoothing parameter.", 0.5, 0.0,
			100.0);
	...
	public Prediction getPredictionForInstance(Instance inst) {
		...
		for (int i = 0; i < this.ensemble.length; i++) {
			...
			combinedVote += vote * getEnsembleMemberWeight(i);
		}
		output[0] = 0;
		output[1] = 0;
