...
import moa.learners.predictors.lazy.neighboursearch.EuclideanDistance;
...
public abstract class KDTreeNodeSplitter implements Serializable {
	 ...
	 */
	public abstract void splitNode(KDTreeNode node, int numNodesCreated, double[][] nodeRanges, double[][] universe)
			throws Exception;
