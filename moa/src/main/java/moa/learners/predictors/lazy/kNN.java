...
import moa.learners.predictors.lazy.neighboursearch.KDTree;
import moa.learners.predictors.lazy.neighboursearch.LinearNNSearch;
import moa.learners.predictors.lazy.neighboursearch.NearestNeighbourSearch;
	...
	public Prediction getPredictionForInstance(Instance inst) {
		...
		try {
			...
			if (this.window.numInstances() > 0) {
				InstancesHeader neighbours = search.kNearestNeighbours(inst,
