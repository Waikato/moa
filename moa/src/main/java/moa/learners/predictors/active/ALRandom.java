...
import moa.learners.predictors.active.budget.BudgetManager;
...
public class ALRandom extends AbstractClassifier implements ALClassifier {
	...
	public ClassOption budgetManagerOption = new ClassOption("budgetManager", 'b', "BudgetManager that should be used.",
