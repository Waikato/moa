...
package moa.learners.predictors.active.budget;
...
public interface BudgetManager {
	...
	/**
	 * Returns true if the given value is above an internal threshold and the label
	 * should be acquired.
	 */
	boolean isAbove(double value);

	/**
	 * Returns the number of labels that have been chosen for acquisition since the
	 * last report.
	 */
