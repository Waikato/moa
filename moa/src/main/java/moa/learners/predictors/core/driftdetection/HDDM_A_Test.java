 ...
 * HDDM<sub><i>A</i>-test</sub> uses the average as estimator. It receives as
 * input a stream of real values and returns the estimated status of the stream:
...
public class HDDM_A_Test extends AbstractChangeDetector {
	...
	public MultiChoiceOption oneSidedTestOption = new MultiChoiceOption("typeOfTest", 't',
			...
			new String[] { "One-sided", "Two-sided" }, new String[] { "One-sided", "Two-sided" }, 1);
