...
public class EWMAChartDM extends AbstractChangeDetector {
	...
	public FloatOption lambdaOption = new FloatOption("lambda", 'l', "Lambda parameter of the EWMA Chart Method", 0.2,
			0.0, Float.MAX_VALUE);
	...
	public void input(double prediction) {
		...
		double L_t = 3.97 - 6.56 * m_p + 48.73 * Math.pow(m_p, 3) - 330.13 * Math.pow(m_p, 5)
