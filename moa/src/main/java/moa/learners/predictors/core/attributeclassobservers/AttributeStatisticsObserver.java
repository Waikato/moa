...
/**
 * Interface for observing the statistics for an attribute. This observer
 * monitors the statistics for a given attribute. Used in
 * AMRulesMultiLabelLearners
 *
...
public interface AttributeStatisticsObserver extends OptionHandler {
	...
	/**
	 * Updates statistics of this observer given an attribute value, the index of
	 * the statistic and the weight of the instance observed
	 *
	 * @param inputAttributeValue the value for the attribute attribute
	 * @param statistics          numOutputs x numStatistics the index of the
	 *                            statistic to store
	 */
