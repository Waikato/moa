...
public class BinaryTreeNumericAttributeClassObserverRegression extends AbstractAttributeClassObserver
	...
	public class Node implements Serializable {
		...
		public double[] lessThan; // This array maintains statistics for the instance reaching the node with
									// attribute values less than or iqual to the cutpoint.

		public double[] greaterThan; // This array maintains statistics for the instance reaching the node with
										// attribute values greater than to the cutpoint.
