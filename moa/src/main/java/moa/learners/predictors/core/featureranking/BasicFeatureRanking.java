...
/**
 * Basic Feature Ranking method João Duarte, João Gama,Feature ranking in
...
public class BasicFeatureRanking extends AbstractFeatureRanking {
	...
	public DoubleVector getFeatureRankings() {
		/*
		 * DoubleVector normRankings=null; if(attributeImportance!=null){
		 * normRankings=new DoubleVector(attributeImportance.getArrayCopy());
		 * normRankings.normalize(); } return normRankings;
		 */
