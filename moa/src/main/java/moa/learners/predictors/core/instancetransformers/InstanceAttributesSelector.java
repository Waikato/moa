...
/**
 * Transforms instances considering both a subset of input attributes and a
 * subset of output attributes
 *
...
public class InstanceAttributesSelector extends InstanceOutputAttributesSelector implements InstanceTransformer {
	...
	public InstanceAttributesSelector(InstancesHeader sourceInstances, int[] targetInputIndices,
