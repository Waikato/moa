...
/**
 * InverseErrorWeightedVoteMuliLabel class for weighted votes based on estimates
 * of errors.
 *
		...
		if (n > 0) {
			...
			for (int o = 0; o < numOutputs; o++) {
				...
				for (int i = 0; i < n; i++) {
					...
					// For each class
					weightedVote.setVote(o, weightedVote.getPrediction(o) + votes.get(i).getPrediction(o) * weights[i][o]);
