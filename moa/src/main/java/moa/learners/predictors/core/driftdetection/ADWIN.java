...
//			object.
		...
		/*
		 * public ListItem(Object element, ListItem nextNode){ // post: initializes the
		 * node to contain the given // object and link to the given next node.
		 * this.data = element; this.next = nextNode; } public ListItem(Object element)
		 * { // post: initializes the node to be a tail node // containing the given
		 * value. this(element, null); }
		 * 
		 * 
