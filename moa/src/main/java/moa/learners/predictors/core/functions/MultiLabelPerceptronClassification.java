...
/**
 * Multi-Label perceptron classifier (by Binary Relevance). This method computes
 * a perceptron classifier per output
 * 
 * @author RSousa
 * @version $Revision: 1 $
 */
public class MultiLabelPerceptronClassification extends AbstractAMRulesFunctionBasicMlLearner
	...
	public MultiLabelPerceptronClassification() {
		// super();
		regressorOption = new ClassOption("baseLearner", 'l', "Perceptron",
				moa.learners.predictors.functions.Perceptron.class, "Perceptron");
