...
public interface MLTask<E extends Example> extends MOAObject, OptionHandler, AWTRenderable {

	/**
	 * Gets whether this learner needs a random seed. Examples of methods that needs
	 * a random seed are bagging and boosting.
	 *
	...
	/**
	 * Gets the learners of this ensemble. Returns null if this learner is a single
	 * learner.
	 *
