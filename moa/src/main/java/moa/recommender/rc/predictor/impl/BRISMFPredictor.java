 ...
 *
 * <ul>
 *   <li>features - the number of features to be trained for each user and item
 *   <li>learning rate - the learning rate used in the regularization
 *   <li>ratio - the regularization ratio to be used in the Tikhonov regularization
 *   <li>iterations - the number of iterations to be used when retraining user and item features
 *       (online training). </lu>
 */
public class BRISMFPredictor implements Updatable {
    ...
    public BRISMFPredictor(
            int nFeatures, RecommenderData data, double lRate, double rFactor, boolean train) {
        this.data = data;
        this.nFeatures = nFeatures;
        this.userFeature = new HashMap<Integer, float[]>();
        this.itemFeature = new HashMap<Integer, float[]>();
