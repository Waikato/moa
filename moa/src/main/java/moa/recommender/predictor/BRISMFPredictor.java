 ...
 * regularization</li>
 * <li>i: iterations - the number of iterations to be used when retraining user
 * and item features (online training).</li> </lu>
 *
 */
...
public class BRISMFPredictor extends AbstractOptionHandler implements RatingPredictor {
	...
	public IntOption featuresOption = new IntOption("features", 'f', "How many features to use.", 20, 0,
			Integer.MAX_VALUE);
	...
	public IntOption iterationsOption = new IntOption("iterations", 'i', "How many iterations to use.", 100, 0,
			Integer.MAX_VALUE);

	public ClassOption dataOption = new ClassOption("data", 'd', "Data", RecommenderData.class,
	...
	protected void prepareForUseImpl(TaskMonitor monitor, ObjectRepository repository) {
		...
		rp = new moa.recommender.rc.predictor.impl.BRISMFPredictor(featuresOption.getValue(), data.getData(),
				lRateOption.getValue(), rFactorOption.getValue(), false);
