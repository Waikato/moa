 ...
 * PLASTIC
 *
 * <p>Restructures the subtrees that would have been pruned by EFDT.
 *
 * <p>See details in:<br>
 ...
 * @version $Revision: 1 $
 */
public class PLASTIC extends AbstractClassifier
        implements MultiClassClassifier, PerformsTreeRevision, MeasuresNumberOfLeaves {
    ...
    public FloatOption splitConfidenceOption =
            new FloatOption(
                    "splitConfidence",
                    'c',
                    "The allowable error in split decision when using fixed confidence. Values"
    ...
    public FloatOption tieThresholdReevalOption =
            new FloatOption(
                    "tieThresholdReevaluation",
                    'T',
                    "Threshold below which a split will be forced to break ties during"
                            + " reevaluation.",
                    0.05,
                    0.0,
                    1.0);

    public FloatOption relMinDeltaG =
            new FloatOption(
                    "relMinDeltaG",
                    'G',
                    "Relative minimum information gain to split a tie during reevaluation.",
                    0.5,
                    0.0,
                    1.0);
    ...
    public MultiChoiceOption leafpredictionOption =
            new MultiChoiceOption(
                    ...
                    new String[] {"MC", "NB", "NBA"},
                    new String[] {"Majority class", "Naive Bayes", "Naive Bayes Adaptive"},
                    2);

    public IntOption maxDepthOption =
            new IntOption(
                    "maxDepth", 'D', "Maximum allowed depth of tree.", 20, 0, Integer.MAX_VALUE);

    public IntOption maxBranchLengthOption =
            new IntOption(
                    "maxBranchLength",
                    'B',
     ...
     *
     * <p>The root is the only access point for the main PLASTIC class. All subtrees etc will simply
     * connect to the root.
     *
     * <p>
     *
    ...
    /**
     * Checks if a tree revision (e.g., pruning or restructuring) was performed at the current time
     * step
     *
     ...
     *
     * <p>Note that calling this function repeatedly causes some overhead as the function traverses
