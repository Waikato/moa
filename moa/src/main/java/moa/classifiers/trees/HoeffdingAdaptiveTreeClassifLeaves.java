 ...
 *
 * <p>First used in the data stream configuration in J. P. Barddal, H. M. Gomes, F. Enembreck, B.
 * Pfahringer {@literal &} A. Bifet. ON DYNAMIC FEATURE WEIGHTING FOR FEATURE DRIFTING DATA STREAMS.
...
public class HoeffdingAdaptiveTreeClassifLeaves extends HoeffdingAdaptiveTree {
    ...
    public class LearningNodeHATClassifier extends AdaLearningNode {
        ...
        public LearningNodeHATClassifier(
        ...
        public double[] getClassVotes(Instance inst, HoeffdingTree ht) {
            if (getWeightSeen()
                    >= ((HoeffdingAdaptiveTreeClassifLeaves) ht).nbThresholdOption.getValue()) {
