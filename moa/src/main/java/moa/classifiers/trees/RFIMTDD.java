 ...
 *    @author Bozhidar Stevanoski <stevanoski.bozidar@gmail.com>
 *
...
/**
 * Implementation of RFIMTDD, regression and model trees for data streams.
 *
 ...
 * Neurocomputing 150 (2015): 458-470.</p>
 */

public class RFIMTDD extends AbstractClassifier implements Regressor {
    ...
    public MultiChoiceOption subspaceSizeOption = new MultiChoiceOption("randomForestFunAttr", 'z',
            ...
            new String[]{"sqrt", "log", "percent"}, new String[]{"Square root", "Logarithm", "50% percent"}, 0);
    ...
    public int numRFAttrs() {
        if (subspaceSize == null) {
            switch (subspaceSizeOption.getChosenLabel()) {
                ...
                case "percent":
                    this.subspaceSize = (int) Math.ceil(0.5 * this.getModelContext().numInputAttributes());
            }
        }
    ...
    public static class LeafNode extends Node {
         ...
         */
        public LeafNode(RFIMTDD tree, int subspaceSize) {
            super(tree);
         ...
         * attribute observer
         */
        public void learnFromInstance(Instance inst, boolean growthAllowed, RFIMTDD rfimtdd) {
            ...
            if (this.listAttributes == null) {
                ...
                for (int j = 0; j < this.numAttributes; j++) {
                    ...
                    while (!isUnique) {
                        this.listAttributes[j] = rfimtdd.classifierRandom.nextInt(inst.numAttributes() - 1);
                        if (!uniques.contains(this.listAttributes[j])) {
                            isUnique = true;
                            uniques.add(this.listAttributes[j]);
                        }
                    }
                }
            }
        ...
        public void checkForSplit(RFIMTDD tree) {
    ...
    public static class SplitNode extends InnerNode {
         ...
         * @param tree
         */
        public SplitNode(InstanceConditionalTest splitTest, RFIMTDD tree) {
            super(tree);
    ...
    public class FIMTDDPerceptron implements Serializable {
        ...
        public FIMTDDPerceptron(RFIMTDD tree) {
            this.tree = tree;
            reset = true;
        }
        ...
        private double denormalizePrediction(double normalizedPrediction, RFIMTDD tree) {
    ...
    public String getPurposeString() {
        return "Implementation of the R-FIMT-DD tree as described by Ikonomovska et al.";
    }
    ...
    protected LeafNode newLeafNode() {
        maxID++;
        return new LeafNode(this, this.numRFAttrs());
    }
