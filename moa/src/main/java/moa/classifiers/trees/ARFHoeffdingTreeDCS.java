 ...
 * @version $Revision: 1 $
 */
public class ARFHoeffdingTreeDCS extends HoeffdingTreeDCS {
    ...
    public static class RandomLearningNode extends ActiveLearningNode {
        ...
        public RandomLearningNode(double[] initialClassObservations, int subspaceSize, long treeDepth) {
    ...
    public static class LearningNodeNB extends RandomLearningNode {
        ...
        public LearningNodeNB(double[] initialClassObservations, int subspaceSize, long treeDepth) {
            super(initialClassObservations, subspaceSize, treeDepth);
        }
    ...
    public static class LearningNodeNBAdaptive extends LearningNodeNB {
        ...
        public LearningNodeNBAdaptive(double[] initialClassObservations, int subspaceSize, long treeDepth) {
            super(initialClassObservations, subspaceSize, treeDepth);
        }
    ...
    protected LearningNode newLearningNode(double[] initialClassObservations, long treeDepth) {
        ...
        if (predictionOption == 0) { //MC
            ret = new RandomLearningNode(initialClassObservations, this.subspaceSizeOption.getValue(), treeDepth);
        } else if (predictionOption == 1) { //NB
            ret = new LearningNodeNB(initialClassObservations, this.subspaceSizeOption.getValue(), treeDepth);
        } else { //NBAdaptive
            ret = new LearningNodeNBAdaptive(initialClassObservations, this.subspaceSizeOption.getValue(), treeDepth);
        }
        return ret;
    }
