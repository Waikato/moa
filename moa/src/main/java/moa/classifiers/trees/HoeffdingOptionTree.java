 ...
 *
 * <p>Hoeffding Option Trees are regular Hoeffding trees containing additional option nodes that
 * allow several tests to be applied, leading to multiple Hoeffding trees as separate paths. They
 * consist of a single structure that efﬁciently represents multiple trees. A particular example can
 * travel down multiple paths of the tree, contributing, in different ways, to different options.
 *
 * <p>See for details:
 *
 * <p>B. Pfahringer, G. Holmes, and R. Kirkby. New options for hoeffding trees. In AI, pages 90–99,
 * 2007.
 *
 * <p>Parameters:
 *
 * <ul>
 *   <li>-o : Maximum number of option paths per node
 ...
 *   <li>-w : The allowable error in secondary split decisions, values closer to 0 will take longer
 *       to decide
 *   <li>-t : Threshold below which a split will be forced to break ties
 *   <li>-b : Only allow binary splits
 *   <li>-z : Memory strategy to use
 *   <li>-r : Disable poor attributes
 *   <li>-p : Disable pre-pruning
 *   <li>-d : File to append option table to.
...
public class HoeffdingOptionTree extends AbstractClassifier
    ...
    public FloatOption secondarySplitConfidenceOption =
            new FloatOption(
                    ...
                    'w',
                    "The allowable error in secondary split decisions, values closer to 0 will take"
                            + " longer to decide.",
                    0.1,
                    0.0,
                    1.0);
    ...
    public FileOption dumpFileOption =
            new FileOption("dumpFile", 'f', "File to append option table to.", null, "csv", true);

    public IntOption memoryStrategyOption =
            new IntOption("memStrategy", 'z', "Memory strategy to use.", 2);
    ...
    public static class Node extends AbstractMOAObject {
        ...
        public FoundNode[] filterInstanceToLeaves(
                Instance inst, SplitNode parent, int parentBranch, boolean updateSplitterCounts) {
    ...
    public static class SplitNode extends Node {
        ...
        public void filterInstanceToLeaves(
            ...
            if (childIndex >= 0) {
                ...
                if (child != null) {
                    child.filterInstanceToLeaves(
                            inst, this, childIndex, foundNodes, updateSplitterCounts);
                } else {
                    foundNodes.add(new FoundNode(null, this, childIndex));
                }
            }
            if (this.nextOption != null) {
                this.nextOption.filterInstanceToLeaves(
                        inst, this, -999, foundNodes, updateSplitterCounts);
            }
        }
    ...
    protected Measurement[] getModelMeasurementsImpl() {
        return new Measurement[] {
            ...
            new Measurement("maximum prediction paths used", this.maxPredictionPaths)
        };
    }
            ...
            if (parentIndex != -999) {
                ...
                double hoeffdingBound =
                        computeHoeffdingBound(
                                ...
                                this.secondarySplitConfidenceOption.getValue(),
                                node.getWeightSeen());
                AttributeSplitSuggestion bestSuggestion =
                        bestSplitSuggestions[bestSplitSuggestions.length - 1];
            ...
            Arrays.sort(
                    ...
                    new Comparator<FoundNode>() {
                        ...
                        public int compare(FoundNode fn1, FoundNode fn2) {
                            ...
                            } else if (HoeffdingOptionTree.this.memoryStrategyOption.getValue()
                                    == 1) {
