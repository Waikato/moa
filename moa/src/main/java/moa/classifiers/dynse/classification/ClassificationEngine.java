...
/* Defines an interface for Classification engines, a module for the dynse classifier */
public interface ClassificationEngine extends MOAObject {

    double[] classify(Instance inst, NearestNeighbourSearch nnSearch,
