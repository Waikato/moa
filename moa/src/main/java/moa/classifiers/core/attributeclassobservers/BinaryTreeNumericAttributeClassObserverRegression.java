 ...
 * observer monitors the class distribution of a given attribute.
 *
 * <p>Learning Adaptive Model Rules from High-Speed Data Streams, ECML 2013, E. Almeida, C.
 * Ferreira, P. Kosina and J. Gama;
 *
 * @author E. Almeida, J. Gama
 * @version $Revision: 2$
 */
public class BinaryTreeNumericAttributeClassObserverRegression extends AbstractOptionHandler
    ...
    public class Node implements Serializable {
        ...
        public double[]
                lessThan; // This array maintains statistics for the instance reaching the node with
        // attribute values less than or iqual to the cutpoint.

        public double[]
                greaterThan; // This array maintains statistics for the instance reaching the node
        // with attribute values greater than to the cutpoint.
        ...
        public Node(double val, double target) {
            ...
            this.lessThan[2] =
                    1.0; // A counter of the number of instances that have reached the node.
    ...
    public AttributeSplitSuggestion getBestEvaluatedSplitSuggestion(
        ...
        return searchForBestSplitOption(
                this.root1, null, null, null, null, false, criterion, preSplitDist, attIndex);
    }
