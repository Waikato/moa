...
public class MedianOfWidestDimension extends KDTreeNodeSplitter {
    ...
    /**
     * Splits a node into two based on the median value of the dimension in which the points have
     * the widest spread. After splitting two new nodes are created and correctly initialised. And,
     * node.left and node.right are set appropriately.
     *
        ...
        node.m_Left =
                new KDTreeNode(
                        ...
                        m_EuclideanDistance.initializeRanges(
                                m_InstList, node.m_Start, medianIdxIdx));
        node.m_Right =
                new KDTreeNode(
                        numNodesCreated + 2,
                        medianIdxIdx + 1,
                        node.m_End,
                        m_EuclideanDistance.initializeRanges(
                                m_InstList, medianIdxIdx + 1, node.m_End));
    }
     ...
     * Algorithms".
     *
     * @param attIdx The dimension/attribute of the instances in which to find the kth-smallest
     *     element.
     * @param indices The master index array containing indices of the instances.
     * @param left The begining index of the portion of the master index array in which to find the
     *     kth-smallest element.
     * @param right The end index of the portion of the master index array in which to find the
     *     kth-smallest element.
