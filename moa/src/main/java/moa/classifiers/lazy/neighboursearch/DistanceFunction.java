...
public interface DistanceFunction {
     ...
     * first, Instance second, double cutOffValue). It may be necessary, depending on the distance
     * function, to do post processing to set the distances on the correct scale. Some distance
     * function classes may not return correct distances using the cutOffValue distance function to
     * minimize the inaccuracies resulting from floating point comparison and manipulation.
     *
