...
public class BasicMultiTargetRegressor extends AbstractMultiLabelLearner
    ...
    public void trainOnInstanceImpl(MultiLabelInstance instance) {
        if (this.hasStarted == false) {
            ...
            if (baseLearner.isRandomizable()) baseLearner.setRandomSeed(this.randomSeed);
    ...
    protected Instance transformInstance(MultiLabelInstance inst, int outputIndex) {
        ...
        if (header[outputIndex] == null) {
            ...
            for (int attributeIndex = 0;
                    attributeIndex < inst.numInputAttributes();
                    attributeIndex++) {
    ...
    public Prediction getPredictionForInstance(MultiLabelInstance instance) {
        ...
        if (this.hasStarted) {
            ...
            for (int i = 0; i < this.ensemble.length; i++) {
                double vote =
                        this.ensemble[i].getVotesForInstance(transformInstance(instance, i))[0];
