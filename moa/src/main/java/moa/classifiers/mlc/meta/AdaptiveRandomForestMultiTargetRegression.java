 ...
 * @version $Revision: 1 $
 */
public class AdaptiveRandomForestMultiTargetRegression extends AbstractMultiTargetRegressor implements MultiTargetRegressor {
    ...
    public ClassOption treeLearnerOption = new ClassOption("treeLearner", 'l',
            "Random Forest Tree.", MultiTargetRegressor.class,
            "iSOUPTreeRF");
    ...
    public void resetLearningImpl() {
        ...
        if(numberOfJobs != AdaptiveRandomForestMultiTargetRegression.SINGLE_THREAD && numberOfJobs != 1)
...
//        BasicClassificationPerformanceEvaluator classificationEvaluator = (BasicClassificationPerformanceEvaluator) getPreparedClassOption(this.evaluatorOption);
        ...
        switch(this.mFeaturesModeOption.getChosenIndex()) {
            case AdaptiveRandomForestMultiTargetRegression.FEATURES_SQRT:
                this.subspaceSize = (int) Math.round(Math.sqrt(n)) + 1;
                break;
            case AdaptiveRandomForestMultiTargetRegression.FEATURES_SQRT_INV:
                this.subspaceSize = n - (int) Math.round(Math.sqrt(n) + 1);
                break;
            case AdaptiveRandomForestMultiTargetRegression.FEATURES_PERCENT:
        ...
        for(int i = 0 ; i < ensembleSize ; ++i) {
            ...
            this.ensemble[i] = new ARFBaseLearnerMTR(
                i, 
                (ISOUPTreeRF) treeLearner.copy(), 
    ...
    protected final class ARFBaseLearnerMTR extends AbstractMOAObject {
        ...
        private void init(int indexOriginal, ISOUPTreeRF instantiatedClassifier, BasicClassificationPerformanceEvaluator evaluatorInstantiated, 
        ...
        public ARFBaseLearnerMTR(int indexOriginal, ISOUPTreeRF instantiatedClassifier, BasicClassificationPerformanceEvaluator evaluatorInstantiated, 
                    long instancesSeen, boolean useBkgLearner, boolean useDriftDetector, ClassOption driftOption, ClassOption warningOption, boolean isBackgroundLearner) {
        ...
        public void trainOnInstance(Instance instance, double weight, long instancesSeen) {
            ...
            if(this.useDriftDetector && !this.isBackgroundLearner) {
        		...
        		if (this.classifier instanceof ISOUPTree) {
        			double[] normalizedError = ((ISOUPTree) this.classifier).getNormalizedError(instance, this.classifier.getPredictionForInstance(instance).asDoubleArray());
                ...
                if(this.useBkgLearner) {
                    ...
                    if(this.warningDetectionMethod.getChange()) {
                        ...
                        this.bkgLearner = new ARFBaseLearnerMTR(indexOriginal, bkgClassifier, bkgEvaluator, instancesSeen, 
    ...
    protected class TrainingRunnable implements Runnable, Callable<Integer> {
        ...
        public TrainingRunnable(ARFBaseLearnerMTR learner, Instance instance, 
