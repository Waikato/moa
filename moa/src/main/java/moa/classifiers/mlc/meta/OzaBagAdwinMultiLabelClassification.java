 ...
 * @version $Revision: 1 $
 */
public class OzaBagAdwinMultiLabelClassification extends AbstractOzaBagAdwin<MultiLabelClassifier> implements MultiLabelClassifier {
	...
	public FloatOption splitConfidenceOption = new FloatOption(
			"classificationThreshold", 't', "The threhshold a label must pass to be predicted as present.",
			0.5, 0.0, 1.0);
