...
public class MultiLabelNominalAttributeObserver extends AbstractOptionHandler
    ...
    public void observeAttribute(double inputAttributeValue, DoubleVector[] observedStatistics) {
        ...
        if (current == null) current = copyOfStatistics(observedStatistics);
        else addStatistics(current, observedStatistics);
    ...
    public AttributeExpansionSuggestion getBestEvaluatedSplitSuggestion(
        ...
        Iterator<Entry<Integer, DoubleVector[]>> it =
                statisticsByNominalValue.entrySet().iterator();
        while (it.hasNext()) {
            ...
            if (merit > bestSuggestionMerit) {
                ...
                bestSuggestiong =
                        new AttributeExpansionSuggestion(
                                ...
                                Utils.copy(resultingStatistics),
                                merit);
            }
        }
