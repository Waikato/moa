...
/**
 * Method for online multi-Label classification. This method consists of the adaptation of the
 * Multi-target Regression method to Multi-label Classification by problem transformation. This also
 * implied the adaption of AMRules to the output binary variable through the substitution of some
 * heurístics such as variance measures by entropy measures.
 *
 * <p>The algorithm is fully explained in the following publication:
 *
 * <p>Sousa R., Gama J. (2016) Online Multi-label Classification with Adaptive Model Rules. In:
 * Luaces O. et al. (eds) Advances in Artificial Intelligence. CAEPIA 2016. Lecture Notes in
 * Computer Science, vol 9868. Springer.
 *
 * @author RSousa
 * @version $Revision: 2 $
 */
public class AMRulesMultiLabelClassifier extends AMRulesMultiLabelLearner
    ...
    public String getPurposeString() {
        return "Method for online multi-Label classification.This method consists of the adaptation"
                + " of the Multi-target Regression method to Multi-label Classification by"
                + " problem transformation.This also implied the adaption of AMRules to the"
                + " output binary variable through the substitution ofsome heurístics such as"
                + " variance measures by entropy measures.";
    }
    ...
    public AMRulesMultiLabelClassifier() {
        ...
        changeDetector =
                new ClassOption(
                        "changeDetector", 'H', "Change Detector.", ChangeDetector.class, "DDM");
    }
