...
/**
 * Transforms instances considering both a subset of input attributes and a subset of output
 * attributes
 *
 * @author João Duarte (joaomaiaduarte@gmail.com)
 */
public class InstanceAttributesSelector extends InstanceOutputAttributesSelector
    ...
    public InstanceAttributesSelector(
            InstancesHeader sourceInstances, int[] targetInputIndices, int[] targetOutputIndices) {
