 ...
 */
public class InstanceOutputAttributesSelector extends AbstractMOAObject
    ...
    public InstanceOutputAttributesSelector(
            InstancesHeader sourceInstances, int[] targetOutputIndices) {
    ...
    public Instance sourceInstanceToTarget(Instance sourceInstance) {
        ...
        for (int i = 0; i < this.targetOutputIndices.length; i++) {
            newInstance.setValue(
                    numInputs + i, sourceInstance.valueOutputAttribute(targetOutputIndices[i]));
        }
