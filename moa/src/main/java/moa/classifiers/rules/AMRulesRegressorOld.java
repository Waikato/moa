 ...
 *     <p>Learning Adaptive Model Rules from High-Speed Data Streams, ECML 2013, E. Almeida, C.
 *     Ferreira, and J. Gama; Project Knowledge Discovery from Data Streams, FCT LIAAD-INESC TEC,.
 *     <p>Parameters:
 *     <ul>
 *       <li>Hoeffding Bound parameters
 *       <li>-c: split Confidence
 *       <li>-t: Tie Threshold
 *       <li>-g: GracePeriod, the number of instances a leaf should observe between split attempts
 *       <li>Page-Hinckley parameters
 *       <li>-H: Drift detection OFF
 *       <li>-a: The alpha value to use in the Page Hinckley change detection tests.
 *       <li>-l: The threshold value (Lambda) to be used in the Page Hinckley change detection
 *           tests.
 *       <li>Anomaly Detection parameters
 *       <li>-A: Anomaly detection ON
 *       <li>-u: Univariate Threshold
 *       <li>-m: Multivariate Threshold
 *       <li>Method parameters
 *       <li>-P: Prediction function to use. Adaptive / Perceptron / Target Mean. Adaptive
 *           predefined
 *       <li>-O: Learn ordered rules. Unordered rule predefined
 *       <li>Perceptron parameters
 *       <li>-s: randomSeed
 *       <li>-r: learning Ratio
 *       <li>-d: learning Ratio Decay
 *       <li>Output Verbose Level
 *       <li>-v: Verbosity level 1 to 5
 *       <li>
 *     </ul>
 */
...
public class AMRulesRegressorOld extends AbstractAMRules implements Regressor {
    ...
    public FlagOption constantLearningRatioDecayOption =
            new FlagOption(
                    "learningRatio_Decay_set_constant",
                    'd',
    ...
    public MultiChoiceOption predictionFunctionOption =
            new MultiChoiceOption(
                    ...
                    new String[] {"Adaptative", "Perceptron", "Target Mean"},
                    new String[] {"Adaptative", "Perceptron", "Target Mean"},
                    0);
    ...
    protected Rule newRule(int ID, RuleActiveLearningNode node, double[] statistics) {
        ...
        if (node != null) {
            if (((RuleActiveRegressionNode) node).getPerceptron() != null) {
                ((RuleActiveRegressionNode) r.getLearningNode())
                        .setPerceptron(
                                new Perceptron(((RuleActiveRegressionNode) node).getPerceptron()));
                ((RuleActiveRegressionNode) r.getLearningNode())
                        .getPerceptron()
                        .setLearningRatio(this.learningRatioOption.getValue());
            }
            if (statistics == null) {
                double mean;
                if (node.getNodeStatistics().getValue(0) > 0) {
                    mean =
                            node.getNodeStatistics().getValue(1)
    ...
    public void getModelDescription(StringBuilder out, int indent) {
        ...
        StringUtils.appendIndented(
                out,
                indent,
                "The prediction function used: " + this.predictionFunctionOption.getChosenLabel());
    ...
    public ErrorWeightedVote newErrorWeightedVote() {
        return (ErrorWeightedVote)
                ((ErrorWeightedVote) votingTypeOption.getPreMaterializedObject()).copy();
    }
}
