 ...
 *
 * <p>In case of imbalanced classes UnderOverBagging uses the strategy of under-sampling the
 * majority class and oversampling the minority class. In addition the sampling rate can be also
 * varied over the bagging iterations, which further boosts the diversity of the base learners.
 *
 * <p>
 *
 * <p>The derivation of the online UnderOverBagging algorithm is made through the observation that a
 * Binomial distribution with sampling rate :math:`\frac{C}{N}` corresponds to a poisson
 * distribution with :math:`\lambda=C`.
 *
 ...
 * @version $Revision: 1 $
 */
public class OnlineUnderOverBagging extends AbstractClassifier
    ...
    public IntOption samplingRateOption =
            new IntOption(
                    "samplingRate", 'i', "The sampling rate of the positive instances.", 2, 1, 10);
