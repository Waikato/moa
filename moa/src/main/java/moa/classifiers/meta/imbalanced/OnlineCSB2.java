 ...
 *
 * <p>CSB2 algorithm is a compromise between AdaBoost and AdaC2. For correctly classified examples,
 * CSB2 treats them in the same way as AdaBoost, while for misclassified examples, it does the same
 * as AdaC2. In addition, the voting weight of each base learner in CSB2 is the same as AdaBoost.
 *
 ...
 * @version $Revision: 1 $
 */
public class OnlineCSB2 extends AbstractClassifier
            ...
            if (k > 0) {
                ...
                if (Utils.maxIndex(this.ensemble.get(i).getVotesForInstance(instance))
                    ...
                    if ((this.epsilon.get(i) + this.wErr.get(i)) != 0 && this.epsilon.get(i) != 1) {
                        lambda =
                                this.epsilon.get(i)
                                        / ((1 - this.epsilon.get(i))
                                                * (this.epsilon.get(i) + this.wErr.get(i)));
                    }
                } else {
                    if (Utils.maxIndex(this.ensemble.get(i).getVotesForInstance(instance)) == 0
                        ...
                        this.wErr.set(
                                i,
                                (this.lambdaFP.get(i) + this.lambdaFN.get(i))
                                        / this.lambdaSum.get(i));
                        lambda =
                                (this.costPositive * lambda)
                                        / (this.epsilon.get(i) * this.wErr.get(i));
                    } else {
