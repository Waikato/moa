 ...
 *
 * <p>Given a set of (heterogeneous) classifiers, BLAST builds an ensemble, and determines the
 * weights of all ensemble members based on their performance on recent observed instances. Used as
 * Abstact Base Class for HeterogeneousEnsembleBlast and HeterogeneousEnsembleBlastFadingFactors.
 *
 * <p>J. N. van Rijn, G. Holmes, B. Pfahringer, J. Vanschoren. Having a Blast: Meta-Learning and
 * Heterogeneous Ensembles for Data Streams. In 2015 IEEE International Conference on Data Mining,
 * pages 1003-1008. IEEE, 2015.
 *
 * <p>Parameters:
 *
 * <ul>
 *   <li>-b : Comma-separated string of classifiers
 *   <li>-g : Grace period (1 = optimal)
 *   <li>-k : Number of active classifiers
 * </ul>
 *
