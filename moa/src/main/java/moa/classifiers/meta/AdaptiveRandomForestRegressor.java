...
/**
 * Implementation of AdaptiveRandomForestRegressor, an extension of AdaptiveRandomForest for
 * classification.
 *
 * <p>See details in:<br>
 * Heitor Murilo Gomes, Jean Paul Barddal, Luis Eduardo Boiko Ferreira, Albert Bifet. Adaptive
 * random forests for data stream regression. In European Symposium on Artificial Neural Networks,
 * Computational Intelligence and Machine Learning (ESANN), 2018.
...
public class AdaptiveRandomForestRegressor extends AbstractClassifier implements Regressor {
    ...
    protected final class ARFFIMTDDBaseLearner extends AbstractMOAObject {
        ...
        private void init(
                int indexOriginal,
                ARFFIMTDD instantiatedClassifier,
