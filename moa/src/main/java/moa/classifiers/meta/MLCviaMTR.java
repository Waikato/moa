...
public class MLCviaMTR extends AbstractMultiLabelLearner implements MultiLabelClassifier {
    ...
    public ClassOption regressorOption =
            new ClassOption(
                    "regressor",
                    'l',
                    "Multi-target regressor to use for MLC .",
                    MultiTargetRegressor.class,
                    "multilabel.trees.ISOUPTree");
    ...
    public void resetLearningImpl() {
        learner =
                (MultiTargetRegressor)
                        ((MultiTargetRegressor) getPreparedClassOption(this.regressorOption))
                                .copy();
    ...
    public void getModelDescription(StringBuilder out, int indent) {
        // TODO This needs to be cleaned up, currently MultiTargetRegressor does not contain
        // getModelDescription
