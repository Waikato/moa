 ...
 *
 * <p>See details in:<br>
 * Nuwan Gunasekara, Bernhard Pfahringer, Heitor Murilo Gomes, Albert Bifet. Gradient Boosted Trees
 * for Evolving Data Streams. Machine Learning, Springer, 2024. <a
 * href="https://doi.org/10.1007/s10994-024-06517-y">DOI</a>.
 *
 * <p>Parameters:
 *
 * <ul>
 *   <li>-l : Classifier to train on instances.
 *   <li>-s : The number of boosting iterations.
 *   <li>-m : Percentage (%) of attributes for each boosting iteration.
 *   <li>-L : Learning rate.
 *   <li>-H : Disable one-hot encoding for regressors that supports nominal attributes.
 *   <li>-M : Multiple training iterations by Ceiling (Hessian * M).
 *   <li>-S : Randomly skipp 1/S th of instances at training (S=1: No Skip, use all instances for
 *       training).
 *   <li>-K : Use Squared Loss for Classification.
 * </ul>
 *
 * @author Nuwan Gunasekara (ng98 at students dot waikato dot ac dot nz)
 * @version $Revision: 1 $
 */
public class StreamingGradientBoostedTrees extends AbstractClassifier
    ...
    public ClassOption baseLearnerOption =
            new ClassOption(
                    ...
                    Classifier.class,
                    "trees.FIMTDD -s VarianceReductionSplitCriterion -g 25 -c 0.05 -e -p");
    ...
    public IntOption percentageOfAttributesForEachBoostingIteration =
            new IntOption(
                    ...
                    'm',
                    "Percentage of attributes % for each boosting iteration.",
                    75,
                    Integer.MIN_VALUE,
                    Integer.MAX_VALUE);
    public FloatOption learningRateOption =
            new FloatOption("learningRate", 'L', "Learning rate", 0.0125, 0, 1.00);
    public FlagOption disableOneHotEncoding =
            new FlagOption(
                    "disableOneHotEncoding",
                    'H',
                    "disable one-hot encoding for regressors that supports nominal attributes.");
    public IntOption multipleIterationByCeilingOfHessianTimesM =
            new IntOption(
                    "multipleIterationByCeilingOfHessianTimesM",
                    'M',
                    "Multiple training iterations by Ceiling (Hessian * M). M = 1: No multiple"
                            + " iterations.",
                    1,
                    1,
                    100);
    public IntOption randomlySkip1SthOfInstancesAtTraining =
            new IntOption(
                    ...
                    'S',
                    "Randomly skip 1/S th of instances at training (S=1: No Skip, use all instances"
                            + " for training).",
                    1,
                    1,
                    Integer.MAX_VALUE);
    public FlagOption useSquaredLossForClassification =
            new FlagOption(
                    "useSquaredLossForClassification", 'K', "Use Squared Loss for Classification.");
    ...
    public void resetLearningImpl() {
        if (super.randomSeedOption.getValue()
                != Integer.parseInt(
                        super.randomSeedOption.getDefaultCLIString())) { // super random set
            this.randomSeedOption.setValue(
                    super.randomSeedOption.getValue()); // override current random
        }
        this.reset = true;
    ...
    public long measureByteSize() {
        ...
        //     }
        // }
        return b; // skip costly measureByteSize calculation to save evaluation time. Uncomment
        // above if you need pararell implimentation
    }
            ...
            if (this.numberClasses <= 2) { // regression or binary classification
                ...
                IntStream.range(0, SGBTCommittee.length)
                        ...
                        .forEach(
                                i ->
                                        votes[i] =
                                                getVoteForPositiveClass(
                                                        SGBTCommittee[i],
                                                        binaryClassInstanceArray[i]));
    ...
    static double getVoteForPositiveClass(SGBT binarySgbt, Instance inst) {
        ...
        if (numOfClassValues > 0) {
            if (numOfClassValues
                    == 1) { // sometimes you would only get one vote, if the base learner has only
                // seen one class
    ...
    public static Instance getSubInstance(
            Instance instance,
            double weight,
    ...
    static double[] getScoreFromSubInstance(
            Instance inst,
            ArrayList<Integer> subSpaceFeaturesIndexes,
            boolean setNumericClassAttribute,
            SGBT.BoostingCommittee b,
            boolean useOneHotEncoding) {
        Instance subInstance =
                getSubInstance(
                        inst,
                        1.0,
                        subSpaceFeaturesIndexes,
                        setNumericClassAttribute,
                        -1,
                        useOneHotEncoding);
    ...
    protected void createSGBTs(int numSGBTs) {
        ...
        base.percentageOfAttributesForEachBoostingIteration.setValue(
                percentageOfAttributesForEachBoostingIteration.getValue());
        ...
        if (this.disableOneHotEncoding.isSet()) {
            if (this.baseLearnerOption.getDefaultCLIString().contains("trees.FIMTDD")) {
                System.out.println(
                        "WARNING: One-hot encoding is DISABLED for baseLearner '"
                                + this.baseLearnerOption.getDefaultCLIString()
                                + "' which does NOT support nominal attributes.");
            }
        }
        base.useOneHotEncoding.setValue(!disableOneHotEncoding.isSet());
        base.multipleIterationByCeilingOfHessianTimesM.setValue(
                multipleIterationByCeilingOfHessianTimesM.getValue());
        base.randomlySkip1SthOfInstancesAtTraining.setValue(
                randomlySkip1SthOfInstancesAtTraining.getValue());
    ...
    Instance[] getBinaryClassInstanceArray(Instance inst) {
        ...
        IntStream.range(0, SGBTCommittee.length)
                ...
                .forEach(
                        i ->
                                binaryClassInstanceArray[i].setClassValue(
                                        (i == actualClass) ? 1.0 : 0.0));
    ...
    public static class SGBT extends AbstractMOAObject {
        ...
        public FlagOption useOneHotEncoding =
                new FlagOption("useOneHotEncoding", 'h', "useOneHotEncoding");
        public IntOption multipleIterationByCeilingOfHessianTimesM =
                new IntOption(
                        "multipleIterationByCeilingOfHessianTimesM",
                        'M',
                        "Multiple training iterations by Ceiling (Hessian * M).",
                        1,
                        1,
                        100);
        public IntOption randomlySkip1SthOfInstancesAtTraining =
                new IntOption(
                        "randomlySkip1SthOfInstancesAtTraining",
                        'S',
                        "Randomly skipp 1/S th of instances at training (S=1: No Skip, use all"
        ...
        public FlagOption useSquaredLossForClassification =
                new FlagOption(
                        ...
                        'K',
                        "Use Squared Loss for Classification.");
        ...
        public void trainOnInstance(Instance inst) {
            ...
            if ((this.randomlySkip1SthOfInstancesAtTraining.getValue() > 1)
                    && (this.classifierRandom.nextInt(
                                    this.randomlySkip1SthOfInstancesAtTraining.getValue())
                            == 0)) {
                // skip training
                return;
            }
        ...
        public void initEnsemble(Instance inst) {
            ...
            if (booster == null) {
                ...
                while (!booster.isEmpty()) booster.remove(0);
            }
            ...
            //                TODO: Assumes class attribute as the last one. We could get into
            // trouble if it is not the case
            ...
            if (k != 0 && k < n) {
                // For low dimensionality it is better to avoid more than 1 classifier with the same
                // subspaces,
                ...
                // For high dimensionality we can't generate all combinations as it is too expensive
                // (memory).
                ...
                // subspaces without worrying about repetitions.
                    ...
                    this.subspaces =
                            StreamingRandomPatches.localRandomKCombinations(
                                    k,
                                    n,
                                    this.numberOfboostingIterations.getValue(),
            ...
            int[] subSpaceIndexes =
                    this.classifierRandom
                            .ints(0, subspaces.size())
                            .distinct()
                            .limit(numberOfboostingIterations.getValue())
                            .toArray();
        ...
        public void trainBoosterUsingSoftmaxCrossEntropyLoss(Instance inst) {
            ...
            for (int m = 0; m < booster.size(); m++) {
                Instance subInstance;
                // compute Derivatives (g and h) using y and sum up raw scores, for all the trees in
                // the committee
                // at m th iteration, gets the adjustment by the m th committee considering all the
                // previous adjustments
                GradHess[] gradHess =
                        mObjective.computeDerivatives(
                                groundTruth, rawScore.getArrayRef(), false, false);
                // create a sub instance from the inst
                subInstance =
                        getSubInstance(
                                inst,
                                1.0,
                                subSpacesForEachBoostingIteration.get(m),
                                true,
                                -1,
                                useOneHotEncoding.isSet());
                ...
                IntStream.range(0, subInstArray.length)
                        ...
                        .forEach(
                                i ->
                                        subInstArray[i].setClassValue(
                                                gradHess[i].gradient / gradHess[i].hessian));
                // train each member of the committee using sub instance with relevant weight and
                // pseudo-label
                booster.get(m)
                        .trainOnInstanceImpl(
                                subInstArray,
                                multipleIterationByCeilingOfHessianTimesM.getValue(),
                                gradHess);
                // get the score from the committee for current subInstance (here we use subInstance
                // for useWeightedInstances==true, as we do not need the label)
                DoubleVector currentScore =
                        new DoubleVector(booster.get(m).getScoresForInstance(subInstance));
        ...
        public DoubleVector getRawScoreForInstance(Instance inst) {
            ...
            if (booster.size() == 1) {
                s[0] =
                        getScoreFromSubInstance(
                                inst,
                                subSpacesForEachBoostingIteration.get(0),
                                true,
                                booster.get(0),
                                useOneHotEncoding.isSet());
            } else {
        ...
        public abstract static class Objective {
            public abstract GradHess[] computeDerivatives(
                    double[] groundTruth,
                    double[] raw,
                    boolean computeNegativeResidual,
                    boolean clipPredictions);
        ...
        public static class SoftmaxCrossEntropy extends Objective implements Serializable {
            ...
            @Override
            public GradHess[] computeDerivatives(
                    double[] groundTruth,
                    double[] raw,
                    boolean computeNegativeResidual,
                    boolean clipPredictions) {
        ...
        static class TreeCommittee implements Serializable {
            ...
            void modelUpdate(
                    Classifier c,
                    Instance inst,
                    int multipleIterationByHessianCeiling,
                    double hessian) {
                double trainTimes =
                        multipleIterationByHessianCeiling > 1
                                ? Math.ceil(hessian * multipleIterationByHessianCeiling)
                                : 1.0;
                            ...
                            .forEach(
                                    i ->
                                            modelUpdate(
                                                    treesCommittee[i],
                                                    instArray[i],
                                                    multipleIterationByHessianCeiling,
                                                    gradHess[i].hessian));
                } else {
                    IntStream.range(0, treesCommittee.length)
                            .parallel()
        ...
        public static class BoostingCommittee implements Serializable {
            ...
            public int measureByteSize() {
                ...
                //                            .forEach(i -> byteSize[i] =
                // treeCommittee.treesCommittee[i].measureByteSize());
                //                }else{
                //                    IntStream.range(0, treeCommittee.treesCommittee.length)
                //                            .parallel()
                //                            .forEach(i -> byteSize[i] =
