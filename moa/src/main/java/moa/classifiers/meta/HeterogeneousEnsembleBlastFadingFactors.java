 ...
 * weights of all ensemble members based on their performance on recent observed instances. This
 * implementation uses fading factors, to emphasize the importance of recent predictions and fade
 * away old predictions.
 *
...
public class HeterogeneousEnsembleBlastFadingFactors extends HeterogeneousEnsembleAbstract
    ...
    public FloatOption alphaOption =
            new FloatOption("alpha", 'a', "The fading factor.", 0.999, 0, 1);
