...
public abstract class HeterogeneousEnsembleAbstract extends AbstractClassifier {
	...
	public ListOption baselearnersOption = new ListOption("baseClassifiers", 'b',
			...
			new ClassOption("learner", ' ', "", Classifier.class, "moa.classifiers.trees.HoeffdingTree"),
			new Option[] {
					new ClassOption("", ' ', "", Classifier.class, "moa.classifiers.bayes.NaiveBayes"),
					new ClassOption("", ' ', "", Classifier.class, "moa.classifiers.functions.Perceptron"),
					new ClassOption("", ' ', "", Classifier.class, "moa.classifiers.functions.SGD"),
					new ClassOption("", ' ', "", Classifier.class, "moa.classifiers.lazy.kNN"),
					new ClassOption("", ' ', "", Classifier.class, "moa.classifiers.trees.HoeffdingTree") },
			',');
	...
	public Prediction getPredictionForInstance(Instance inst) {
		...
		for (int i = 0; i < topK.size(); ++i) {
			double[] memberVotes = normalize(
					ensemble[topK.get(i)].getPredictionForInstance(inst).asDoubleArray());
			double weight = 1.0;
