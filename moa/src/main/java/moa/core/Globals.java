...
public class Globals {
    ...
    public static final String versionString = " 23.04 April 2023";

    public static final String copyrightNotice = "(C) 2007-2023 University of Waikato, Hamilton, New Zealand";
