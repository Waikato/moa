...
public final class PropertiesReader {
    ...
    /**
     * Reads properties that inherit from three locations. Properties are first defined in the
     * system resource location (i.e. in the CLASSPATH). These default properties must exist.
     * Properties defined in the users home directory (optional) override default settings.
     ...
     *     "weka/core/Utils.props". (The use of hardcoded forward slashes here is OK - see
     *     jdk1.1/docs/guide/misc/resources.html) This routine will also look for the file (in this
     *     case) "Utils.props" in the users home directory and the current directory.
    ...
    public static Properties readProperties(String resourceName) throws Exception {
        ...
        try {
            ...
            defaultProps.load(
                    (new Utils()).getClass().getClassLoader().getResourceAsStream(resourceName));
        } catch (Exception ex) {
