...
public final class PropertiesReader {
	 ...
	 * default properties must exist. Properties defined in the users home directory
	 * (optional) override default settings. Properties defined in the current
	 * directory (optional) override all these settings.
	 *
