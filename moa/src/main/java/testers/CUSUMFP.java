...
public class CUSUMFP implements Tester
{
    int iterations = 100;
...
//		    BufferedWriter bWriter = new BufferedWriter(new FileWriter("src\\testers\\Volatility&ChangeDetection\\" + "Test" + "\\EDD_" + numInstances + "_" + iterations + ".csv"));
		    BufferedWriter bWriter = new BufferedWriter(new FileWriter("src\\testers\\Volatility&ChangeDetection\\" + "Test" + "\\CUSUM\\"+ "FP_Ensemble_200_5_cusumadwinsingphtedd_0.4.csv"));
			...
			for (int j = 0; j < deltas.length; j++)
			{
				...
				//CutPointDetector[] ens = new CutPointDetector[]{new CUSUM(40), new CUSUM(45), new CUSUM(50), new CUSUM(55), new CUSUM(60)};
