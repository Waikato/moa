...
public class TruePositiveTester implements Tester {
				...
				for (int w = 0; w < alphas.length; w++) {
					for (int q = 0; q < epsilonPrimes.length; q++) {
						for (int i = 0; i < numInst.length; i++) {
							...
							// blockSize + "_"+ DECAY_MODE + "_" +
							// COMPRESSION_MODE + "_" + "L-" + numDriftInstances
							// + "_" + compTerms[e] + "_" + epsilonPrimes[q] +
							// "_" + alphas[w] + "_" + numInst[i] + ".csv"));
							BufferedWriter bWriter = new BufferedWriter(
									new FileWriter("src\\testers\\Volatility&ChangeDetection\\Test\\kddcup.csv"));

							bWriter.write(
									"Slope,Number of Drifts,TP Rate,Avg Delay,Delay Stdev,Avg Time,Time Stdev,Compression Rate,Avg No. Checks,Checks Stdev,Memory Size");
							// bWriter.write("Slope,Number of Drifts,TP Rate,Avg
							// Delay,Delay Stdev,Avg Time,Time Stdev,Memory
							// Size");
							bWriter.newLine();
							for (int j = 0; j < slopes.length; j++) {
								...
								for (int k = 0; k < iterations; k++) {
									...
									BufferedReader br = new BufferedReader(
											new FileReader("C:\\Users\\ACER\\Desktop\\kddcup99.csv"));
									// BufferedReader br = new
									// BufferedReader(new
									// FileReader("src\\testers\\TPData.txt"));
									// BufferedReader br = new
									// BufferedReader(new
									// FileReader("src\\testers\\Volatility&ChangeDetection\\VolatilityStreamDriftPoint\\3\\VolatilityStream_3_"+k+".csv"));
									String line = "";
								...
								// bWriter.write((double) totalCompCount /
								// iterations + ",");
								...
								// bWriter.write((double)totalWarningCount /
								// (double)iterations + "");
								bWriter.newLine();
							}
							bWriter.close();
