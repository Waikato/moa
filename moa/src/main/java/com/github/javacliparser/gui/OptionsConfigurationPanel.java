...
public class OptionsConfigurationPanel extends JPanel {
	...
	public OptionsConfigurationPanel(String purposeString, Options options) {
		...
		JScrollPane scrollPane = new JScrollPane(optionsPanel, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED,
	...
	public static boolean showEditOptionsDialog(Component parent, String title, OptionHandler optionHandler) {
		OptionsConfigurationPanel panel = new OptionsConfigurationPanel(optionHandler.getPurposeString(),
	...
	public void showHelpDialog() {
		...
		JOptionPane.showMessageDialog(this, new JScrollPane(helpTextArea), "Options Help",
	...
	protected static JPanel createLabelledOptionComponentListPanel(Option[] options,
