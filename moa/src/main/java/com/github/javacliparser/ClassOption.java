	...
	public static Object cliStringToObject(String cliString, Class<?> requiredType, Option[] externalOptions)
		...
		try {
			...
			try {
				...
				/*
				 * } catch (Throwable t2) { try { // try prepending task package classObject =
		...
		// || ((classInstance instanceof Task) && requiredType.isAssignableFrom(((Task)
		// classInstance).getTaskResultType()))
		) {
