...
public abstract class AbstractClassOption extends AbstractOption {
	...
	public void setCurrentObject(Object obj) {
		if (((obj == null) && (this.nullString != null)) || this.requiredType.isInstance(obj) || (obj instanceof String)
				|| (obj instanceof File)
		// || ((obj instanceof Task) && this.requiredType.isAssignableFrom(((Task)
		// obj).getTaskResultType()))
		) {
	...
	public Object materializeObject() {
		if ((this.currentValue == null) || this.requiredType.isInstance(this.currentValue)) {
			return this.currentValue;
			/*
			 * } else if (this.currentValue instanceof String) { if (repository != null) {
			 * Object inmemObj = repository.getObjectNamed((String) this.currentValue); if
			 * (inmemObj == null) { throw new RuntimeException("No object named " +
			 * this.currentValue + " found in repository."); } return inmemObj; } throw new
			 * RuntimeException("No object repository available.");
			 */
	...
	public static String classToCLIString(Class<?> aClass, Class<?> requiredType) {
		...
		if (className.startsWith(packageName)) {
			 ...
			 * else if (Task.class.isAssignableFrom(aClass)) { packageName =
			 * Task.class.getPackage().getName(); if (className.startsWith(packageName)) {
			 * // cut off task package name className =
