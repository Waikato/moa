...
public interface Prediction {
	...
	/**
	 * Different output attributes may have different number of classes. Used for
	 ...
	 */
	double getPrediction(int outputAttributeIndex);
	 ...
	 *
	 */
	void setVote(int outputAttributeIndex, double vote);
	...
	/**
	 * The DoubleVector of the predictions. Used for multi-target regression and
	...
	/**
	 * The double array of votes for specific labels. Used for classification and
	 * multi-label classification.
	 *
