...
public class Instances implements Serializable {
	 ...
	 *                         inputs)
	 */
	public Instances(Reader reader, String outputDefinition) {
	 ...
	 */
	public Instances(Reader reader, String outputDefinition, String inputDefinition) {
	...
	public Instances(String st, Attribute[] v, int capacity) {
		this.instanceInformation = new InstanceInformation(st, Arrays.asList(v));
		if (capacity < 0) {
			capacity = 0;
		}
		this.instances = new ArrayList<>(capacity);
	...
	public Instances getEmptyHeader() {
    ...
    public void setAttributes(Attribute[] v, List<Integer> indexValues) {
        if (this.instanceInformation == null) {
            this.instanceInformation = new InstanceInformation();
        }
        this.instanceInformation.setAttributes(v, indexValues);
	...
	public static String getClassNameString(Instances context) {
		if (context == null) {
			return "[class]";
		}
	...
	public static String getClassLabelString(Instances context, int classLabelIndex) {
	...
	public static String getAttributeNameString(Instances context, int attIndex) {
	...
	public static String getInputAttributeNameString(Instances context, int attIndex) {
	...
	public static String getNominalValueString(Instances context, int attIndex, int valIndex) {
		if (context != null) {
	...
	public static String getNumericValueString(Instances context, int attIndex, double value) {
		if (context != null) {
