 ...
 *
 * This class is an extension to the original SparseInstance. It has been
 * created to be used with feature selection algorithms for data streams. In
 * contrast to SparseInstance objects, missing values are represented as NaNs
 * instead of 0s (zeros). This allows learners to skip features with missing
 * values.
 *
