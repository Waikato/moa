...
public class ArffLoader {
                    ...
                    if (streamTokenizer.ttype == StreamTokenizer.TT_NUMBER) {
                        ...
                        numAttribute++;
                            ...
                            && (streamTokenizer.ttype == StreamTokenizer.TT_WORD
                                    ...
                                    || streamTokenizer.ttype == 39)) {
                        // System.out.println(streamTokenizer.sval + "Str");
                        boolean isNumeric =
                                this.instanceInformation.attribute(numAttribute).isNumeric();
                        double value;
    ...
    protected void setValue(Instance instance, int numAttribute, double value, boolean isNumber) {
        ...
        if (isNumber && this.instanceInformation.attribute(numAttribute).isNominal) {
            valueAttribute =
                    this.instanceInformation
                            .attribute(numAttribute)
                            .indexOfValue(Double.toString(value));
    ...
    private Instance readInstanceSparse() {
        ...
        Instance instance =
                newSparseInstance(
                        1.0); // , null); //(this.instanceInformation.numAttributes() + 1);
        // System.out.println(this.instanceInformation.numAttributes());
        int numAttribute;
                    ...
                    if (streamTokenizer.ttype == StreamTokenizer.TT_NUMBER) {
                        ...
                        if (this.auxAttributes.get(numAttribute).isNumeric()) {
                            this.setSparseValue(
                                    ...
                                    attributeValues,
                                    numAttribute,
                                    Double.valueOf(streamTokenizer.sval).doubleValue(),
                                    true);
                        } else {
                            this.setSparseValue(
                                    instance,
        ...
        instance.addSparseValues(
                arrayIndexValues, arrayAttributeValues, this.instanceInformation.numAttributes());
        return instance;
    }

    private void setSparseValue(
            Instance instance,
    ...
    private InstanceInformation getHeader() {
        // commented JD
        // this.range.setUpper(10000); //TO DO: Create a new range object with isInRange that does
        // not need the upper limit
