 ...
 *
 * This class is an extension to the original SparseInstanceData. It has been
 * created to be used with feature selection algorithms for data streams. In
 * contrast to SparseInstanceData objects, missing values are represented as
 * NaNs instead of 0s (zeros). This allows learners to skip features with
 * missing values.
 *
...
public class FilteredSparseInstanceData extends SparseInstanceData {
	...
	/**
	 * Value of the attribute in the indexAttribute position. If this value is
	 * absent, a NaN value (marker of missing value) is returned, otherwise this
