...
public class Attribute implements Serializable {
	...
	/** The keyword used to denote a hierarchical attribute */
	public final static String ARFF_ATTRIBUTE_HIERARCHICAL = "hierarchical";
	 ...
	 */
	protected AttributeStructure attributeStructure;
	 ...
	 * @param attributeName      the attribute name
	 * @param attributeValues    the attribute values
	 * @param attributeStructure the attribute structure
	 */
	public Attribute(String attributeName, List<String> attributeValues, AttributeStructure attributeStructure) {
		this.name = attributeName;
		this.attributeValues = attributeValues;
	...
	public final int indexOfValue(String value) {
		...
		// TODO check how this affects hierarchies
		...
		// in case value was not on a list of unique values of nominal attribute yet,
		// add it
		// Hence, the list of values can be extended with new entries arriving in the
		// stream
		if (val == null) {
	...
	public final String toString() {
		...
		if (this.isNominal) {
			...
			text.append(ARFF_ATTRIBUTE_HIERARCHICAL).append(" ");

			text.append("{");
			// TODO output hierarchy
			text.append("}");
