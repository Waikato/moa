...
public class MOAUtils {
	...
	/**
	 * Returs the commandline for the given object. If the object is not derived
	 * from AbstractOptionHandler, then only the classname. Otherwise the classname
	 * and the options are returned.
	 * 
