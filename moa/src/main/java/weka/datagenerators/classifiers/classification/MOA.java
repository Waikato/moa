...
/**
 * <!-- globalinfo-start --> A wrapper around MOA instance streams.
 * <p/>
 * <!-- globalinfo-end -->
 * 
...
public class MOA extends ClassificationGenerator {
	...
	protected ClassOption m_Generator = new ClassOption("InstanceStream", 'B',
			"The MOA instance stream generator to use from within WEKA.", InstanceStream.class,
