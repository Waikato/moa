...
public class WriteToTopicTask extends AuxiliarMainTask implements CapabilitiesHandler {
    ...
    protected Object doMainTask(TaskMonitor monitor, ObjectRepository repository) {
        ...
        KafkaProducer<Long, Instance> producer = new KafkaProducer<>(getProducerConfig(host, port));
        ...
        while (i < maxInstances) {
            ...
            ProducerRecord<Long, Instance> record =
                    new ProducerRecord<>(topic, (long) i++, inst.getData());
            ...
            long totalInstances = remainingInstances >= 0 ? i + remainingInstances : maxInstances;
        ...
        producer.send(new ProducerRecord<>(topic, (long) i, null));
