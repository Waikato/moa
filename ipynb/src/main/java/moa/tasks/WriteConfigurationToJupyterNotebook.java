...
public class WriteConfigurationToJupyterNotebook extends AuxiliarMainTask {
     ...
     *
     * @param jsonCells The list of JSON cells in the notebook.
     */
    public void createAllCells(ArrayList<JSONCell> jsonCells) {
        StringBuilder builder = new StringBuilder(this.cells);

        for (int i = 0; i < jsonCells.size(); i++) {
            jsonCells.get(i).addToCell(Integer.toString(i + 1), 2);
            builder.append("\n");
            builder.append(jsonCells.get(i).getCell());
            if (i != jsonCells.size() - 1)
                builder.append(",\n");
        }
        ...
        try {
            ...
            if ((this.task instanceof EvaluateInterleavedTestThenTrain) || (this.task instanceof EvaluatePrequential) ||
                ...
                try {
                    ...
                    this.createAllCells(this.exportNotebook(
                          currentTask,
                          streamString,
                          learnerString,
                          evaluatorString,
    ...
    protected ArrayList<JSONCell> exportNotebook(
          Task currentTask,
          String streamString,
          String learnerString,
          String evaluatorString,
          File dumpFile,
          File outputPredictionFile,
          int randomSeed,
          int instanceLimit,
          int timeLimit,
          int sampleFrequency,
          ...
          double alphaOption,
          int cellNum) {
        ArrayList<JSONCell> jsonCells = new ArrayList<>();
        ...
        if (this.exportAdvancedNotebook.isSet()) {
            ...
            if ((currentTask instanceof EvaluatePrequential) || (currentTask instanceof EvaluatePrequentialDelayed) ||
                ...
                if (outputPredictionFile != null) {
                    ...
                    c3.addNewLineToCell("File outputPredictionFile = null;", 5);
         ...
         */
            ...
            if (currentTask instanceof EvaluateInterleavedTestThenTrain || currentTask instanceof EvaluatePrequential || currentTask instanceof EvaluatePrequentialCV
                ...
                if (currentTask instanceof EvaluateInterleavedTestThenTrain)
                    ...
                    c3.addNewLineToCell("eval.setEvaluationScheme(\\\"" + currentTask.getClass().getName().substring(18) + "\\\");", 5);
